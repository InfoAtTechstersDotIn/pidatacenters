...
<div class="picloud_pages">
 ...
 -->
    ...
    <div class="hb-btn_cl" style="text-align: center;"><a href="images/new-multi-cloud-brochure.pdf" class="global-button" target="_blank">
            Download Brochure
        </a>
                        ...
                        <li>
                            <div class="hb-boxCont text-center" style="min-height:auto">
                                <a href="javascript:void(0)" style="cursor: auto;">
                                    <span>
                                        <!-- <img src="./images/logo/1.png" alt="data"> -->
                        ...
                        <li>
                            <div class="hb-boxCont text-center" style="min-height:auto">
                                <a href="javascript:void(0)" style="cursor: auto;">
                                    <span>
                                        <!--  <img src="./pi-cloud/images/logo/18.png" alt="uptime"> -->
                                        <img src="./pi-cloud/images/product-images/azure28.png" alt="A-La-Carte-Model-4" style="width: 85px;">
