                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    <div class="flex-grow-1">
                                        <h4 class="fs-16 mb-1"> <?php print $username;?>!</h4>
...
?>
                                                        ...
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Case Studies</p>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Brochures</p>
