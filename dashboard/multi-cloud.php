...
?>
<style>
.stick{border-radius:80px;max-width:40%;}
...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/Web-Banner17.jpg">
			      <img  src="images/banners/Web-Banner17.jpg" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
...
<p>Our Multi-Cloud Ecosystem has been a safe harbor for enterprises with diverse needs. We strive to empower businesses with the tools they need to succeed in today's fast-paced digital landscape. The numerous used cases of enterprises trusting and partnering with us in infusing their business goals and staying ahead of the curve are testimonials in themselves. 
			...
			<br><br>
             ...
             <div class="hb-productHead text-center">
				...
				<p>Harbour 1® offers enterprises the luxury of hosting diverse workloads seamlessly across multiple cloud providers, thereby maximizing the benefits gained from each cloud provider's strengths and mitigating their weaknesses.This approach to multi-cloud hosting also ensures that businesses have access to a wider range of services and features, resulting in increased flexibility and scalability for their operations.
				The key features of Harbour 1®’s cloud computing approach encompass several critical elements that enable our clients to operate in today's rapidly evolving business environment.</p>
			</div>
			            	...
			            	<ul class="list-inline hb-featuresList multi-cld-key">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/key-feature-1.png" alt="scale">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/key-feature-2.png" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/key-feature-3.png" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
                                ...
                                <li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/key-feature-4.png" alt="scale">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/key-feature-5.png" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
                                        ...
                                        <p style="text-align:center;">At Harbour1, we understand the importance of cost optimization and competitive pricing. We work closely with our customers to ensure that they are getting the best value for their investment without sacrificing the quality of our services.</p>
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/key-feature-6.png" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
			            						<h6>Optimal Mix Of Services From Across Cloud Platforms</h6>
			...
			<div class="hb-childProducts">
				...
				<div id="outer" class="skltbs-theme-light" data-skeletabs='{ "startIndex": 3 }'>
			        <ul class="skltbs-tab-group list-inline text-center">
			          ...
			          <li class="skltbs-tab-item">
			            <button class="skltbs-tab tab-link" data-tab="tab-3">Why Multi-Cloud On Harbour 1®</button>
			          </li>
			        ...
			        <div class="skltbs-panel-group">
                          ...
                          <p>Harbour 1® Managed Multi-Cloud Services offer businesses the flexibility to choose from multiple cloud providers, including AWS, Azure, Google Cloud, and Oracle, while ensuring seamless integration and efficient management of all cloud services.</p>
						   <p>Our managed multi-cloud services are designed to meet the growing demand for scalable, secure, and high-performance cloud computing solutions. Our team of cloud specialists has extensive expertise in designing, implementing, and managing multi-cloud environments, helping businesses optimize their cloud infrastructure to achieve their desired outcomes.</p>
						    <p>Our managed multi-cloud services offer businesses the peace of mind they need to focus on their core activities while we manage their cloud environment.If you're looking for a reliable and efficiently managed multi-cloud service provider, Harbour 1® is the perfect partner for your business.</p><br>
							  <!--<span>
                 ...
                 <a href="#"> <img src="images/product-images/aws21.png" alt="certfication" style="max-width:100%"></a>
                
          </div>
		     <div class="item" style="margin-top:60px">
                
                    <a href="#"><img src="images/product-images/Managed-multi-cloud-system24.png" alt="certfication" style="max-width:100%"></a>
                
          </div>	
		  <div class="item" style="margin-top:60px">
                
                  <img src="images/product-images/gOOGLE21.png" alt="certfication" style="max-width:100%">
               
          </div> 
	  
		  <div class="item" style="margin-top:60px">
               
                  <img src="images/product-images/oRACLE21.png" alt="certfication" style="max-width:100%">
              
          </div>
       
		   <div class="item" style="margin-top:60px">
                
                  <img src="images/product-images/Azure21.png" alt="certfication" style="max-width:100%">
			          ...
			          <ul class="hb-productSec list-inline">
			            		<div class="hb-leftCont hb_ppCont">
			            			<p>The Harbour 1® Multi-Cloud Ecosystem simplifies workload management by providing a unified view of all your workloads across multiple clouds. With Harbour 1®, you can monitor the performance of your workloads from a single location and optimize your environment for better cost control.</p>
                                    
                                    <p >Having a single pane of glass view for workload management not only provides a more efficient and streamlined approach but also enables you to achieve your business goals with greater ease. By reducing the complexity of managing multiple clouds, Harbour  1® enables you to focus on innovation and growth rather than just keeping the lights on.</p>
                                     <p >So whether you are looking to migrate to the cloud, optimize your existing cloud environment, or manage multiple clouds, Harbour 1® is the solution that can provide you with the unified view and tools you need to succeed in today's digital landscape. With Harbour 1®, you can simplify your cloud management, improve your ROI, and achieve your business objectives with ease.</p>
                                    <span>
			            				<!--<img src="images/product-images/containers_img.png" alt="workspace">-->
											<img src="images/product-images/single-pane-of-glass.png" alt="workspace">
			            			</span>
			            		</div>
			          ...
			          <ul class="hb-productSec list-inline">
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p>In today's fast-paced business landscape, it's critical for organizations to be able to quickly adapt and scale to keep up with changing market demands. That's where Harbour 1® Multi-Cloud Ecosystem comes in: by providing a unified view for workload management across various cloud environments, businesses can streamline their operations, improve data sovereignty and compliance, and optimize their costs. </p>
									...
									<p>The Harbour 1® Multi-Cloud Ecosystem offers a comprehensive platform for efficient workload management, giving businesses the tools they need to stay agile and competitive in today's digital age. Choose Harbour1 and experience the benefits of a single pane of glass view for your business.</p>

                                    <span>
			            				<img src="images/product-images/Managed-Services-Models-c.png" alt="workspace">
			            			</span>
			            		</div>
					...
					<h1 class="text-center" style="padding:30px 0 0;color:#545454;margin-top:-80px;">Managed Services Models</h1>
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/Managed-Services-Models.png" alt="tickmark">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
...
Provides different tiers of service levels based on the business's needs, ensuring that you pay only for the services you require. 
 ...
 <ul style=" list-style-type: circle;list-style-position:outside;font-size: 16px;
    line-height: 22px; ">
 <li>24 X 7 support with 2 hr. critical response</li>
 <li>Basic IT support (OS patching, OS updates, OS Management, Virtual Machines, Disks, basic configuration management, incident management)</li>
 ...
 <li>Basic anti-virus and anti-malware support</li>
							...
							<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/essesntials-la.png" alt="tickmark" style="margin-top:50px;float:right;width:auto;">
			            			</span>
			            		</div>
			            	</li>
			            </ul>
						 <ul class="hb-productSec list-inline" style="margin-top:30px">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/advanced-la.png" alt="tickmark" style="width:auto;">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
...
<ul style=" list-style-type: circle;list-style-position:outside;font-size: 16px;
    line-height: 22px;">
	<li>24 X 7 support with 1 hr. critical response</li>
	<li>Advanced IT support (OS patching, OS updates, OS Management, Virtual Machines, Virtual Machine scales etc, Availability Sets, Disks, Virtual Networks, WAF, Identity Management, Configuration management, incident management, Problem Management, Change Management)</li>
...
<ul style=" list-style-type: circle;list-style-position:outside;font-size: 16px;
    line-height: 22px;">
	<li>24 X 7 support with 30 min critical response</li>
	...
	<li>Advanced operational intelligence and custom dashboard on usage, performance, governance, and cost</li>
							...
							<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/premium-la.png" alt="tickmark" style="width:auto;float:right">
			            			</span>
			            		</div>
			            	</li>
			            </ul>
...
Allows businesses to pay only for what they use, making it a cost-effective model.
			            			...
			            			<span>
			            				<img src="images/product-images/Elastic-Model.png" alt="advanced">
			            			</span>
...
This model provides businesses with devoted resources for managing their workloads, ensuring they receive the necessary attention.
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo" style="width:100%;text-align:center">
			            						<img src="images/Service-Monitoring11.png" alt="scale" style="max-width:50%;">
			            					</p>
  ...
  <li>In daily work, a consolidated monitoring of the systems and services operated is achieved by means of service monitoring.</li>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo" style="width:100%;text-align:center">
			            						<img src="images/Hourly-Support11.png" alt="scale" style="max-width:50%;">
			            					</p>
			            					<div class="hb-featCont" style="width:100%;text-align:Center">
	...
	<ul style=" list-style-type: circle;list-style-position: inside;width: 100% !important;margin: 0 auto;">
  <li>24/7</li>
  <li>16/7</li>
  <li>8/7</li>
</ul>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo" style="width:100%;text-align:center">
			            						<img src="images/Third-Party-Integration11.png" alt="scale" style="max-width:50%;">
			            					</p>
			            					<div class="hb-featCont" style="width:100%;text-align:Center">
...
Allows businesses to select specific services they require, providing flexibility in the services chosen.
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-1.png" alt="A-La-Carte-Model-1" style="width:300px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-2.png" alt="A-La-Carte-Model-2">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-3.png" alt="A-La-Carte-Model-3">
			            			</div>
			            		</li>
                                <li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-4.png" alt="A-La-Carte-Model-4">
			            			</div>
			            		</li>
                                        <li class=" emty-blk"></li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-5.png" alt="A-La-Carte-Model-5">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-6.png" alt="A-La-Carte-Model-6">
			            			</div>
			            		</li>
                                        <li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-7.png" alt="A-La-Carte-Model-7">
			            			</div>
			            		</li>
                                         <li class="emty-blk"></li>
			            	</ul>
...
Provides businesses with monitoring services while allowing them to manage their workloads themselves.
						 ...
						 <ul class="hb-productSec list-inline" style="margin-top:30px">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/Dedicated-Model.png" alt="tickmark" style="width:auto;">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
               ...
               <!--<ul class="hb-productSec list-inline appoinment">
				...
				<br><br>
				 ...
				 <ul class="hb-productSec list-inline">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/AES212.png" alt="A-La-Carte-Model-1" style="width:100px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/Oracle212.png" alt="A-La-Carte-Model-2" style="width:100px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/Google212.png" alt="A-La-Carte-Model-3" style="width:100px">
			            			</div>
			            		</li>
                                <li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/azure212.png" alt="A-La-Carte-Model-4" style="width:100px">
			            			</div>
			            		</li>
				 ...
				 <a href="/contact-us" style="width:100%"><ul class="hb-productSec list-inline appoinment stick" style="max-width:40% !important">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
                    ...
                    <!--<a href="#">Schedule A Visit</a>-->
			            	...
			            	<!--<li>
			            		<div class="hb-rightCont hb_ppCont">
                                   ...
                                   <a href="https://harbour1.in/contact-us">Click Here</a>
