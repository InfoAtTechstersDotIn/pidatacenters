                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                                <i class="fas fa-home"></i> New Gallery
                                            </a>
                                        </li>
...
//$uploads_dir = $_SERVER['DOCUMENT_ROOT'] . "/dashboard/uploads/";
...
if($status=="OK")
{
     $qf=mysqli_query($con,"INSERT INTO testimony (name, ufile) VALUES ('$namex', '$new_file_name')");
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   ?>
              <form action="" method="post" enctype="multipart/form-data">
                                              ...
                                              <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Gallery Name</label>
