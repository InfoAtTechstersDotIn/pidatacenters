	...
	<div class="hb-bannerCont">
		<div class="hb-bannerImgCont">
			<div class="hb-bannerImg">
				<!--	<picture>
			     <source media="(max-width: 768px)" srcset="./pi-cloud/images/banners/ce_mbanner.png">
			      <img  src="./pi-cloud/images/banners/ce_banner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>-->
				<picture>
					<source media="(max-width: 768px)" srcset="https://pidatacenters.com/pi-cloud/images/banners/cloud-enablement-banner.jpg">
					<img src="https://pidatacenters.com/pi-cloud/images/banners/cloud-enablement-banner.jpg" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
				</picture>
		...
		<div class="hb-ceTpHeader">
			<div class="container">
				<div class="hb-ce-tpCont text-center">
					...
					<p class="color_black">As enterprises move towards adoption of cloud at scale, managing the new ecosystem can be cumbersome and challenging. It would need significant investment of time, resources, skill upliftment and process restructuring, to name a few. Cloud Enablement Services on Pi Cloud<sup></sup> takes care of end to end cloud adoption, migration and management, allowing enterprises to focus on their core.</p>
				</div>
				...
				<ul class="list-inline hb-JournLists">
					<li>
						<div class="hb-cuJoBox">
							<span>
								<img src="./pi-cloud/images/menu-icons/foundation_ico-2.svg" alt="journey">
							</span>
							<h3>Foundation</h3>
					...
					<li>
						<div class="hb-cuJoBox">
							<span>
								<img src="./pi-cloud/images/menu-icons/migration_ico -2.svg" alt="journey">
					...
					<li>
						<div class="hb-cuJoBox">
							<span>
								<img src="./pi-cloud/images/menu-icons/operate_ico -2.svg" alt="journey">
					...
					<li>
						<div class="hb-cuJoBox">
							<span>
								<img src="./pi-cloud/images/menu-icons/optimize_ico -2.svg" alt="journey">
		...
		<div class="hb-deContO">
			<div class="container">
				<div class="hb-jorInfo text-center">
					<h2 style="color:#fff !Important;">Journey with Pi Cloud<sup></sup> Managed Services</h2>
			...
			<ul class="hb-ServiceDef list-inline" style="border-top: 1px solid #cccc; padding-top: 50px;">
				<li>
					<div class="hb-service-INfo">
						...
						<p>Our purpose aligned Managed Services not only operates enterprise workloads hosted on Pi Cloud, but also manages third party cloud installations and infrastructure hosted in-house. It provides secure and industry compliant ecosystem, day-to-day management of infrastructure and ongoing cost optimization. All of it being measurable vis a vis SLA driven business objectives.</p>
					</div>
