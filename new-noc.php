        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h4>Our team of highly trained NOC engineers is available around the clock and carries out activities like: </h4>
                </div>
            </div>


            <div class="noc-part-2">
                <div class="row mt-4">
                    <div class="col-md-12 mt"><img src="images/new-noc-1.png"></div>
                    <div class="col-md-6 bullets mt-3">
                        <ul>
                            <li>Network Monitoring and Updates </li>
                    ...
                    <div class="col-md-6 bullets single-point">
                        <ul>
            ...
            <div class="noc-part-3">
                <h2>Why <span style="color: #76b543;">NOC @ Pi</span>?</h2>
                <div class="row">
                    <div class="col-md-5">
                        <img src="images/new-noc-2.png">
                    </div>
            ...
            <div class="noc-part-5">
                ...
                <div class="container">
                    ...
                    <div class="last-para">
                        <p>Choose Pi for a partnership that goes beyond mere surveillance, offering proactive support and optimization to propel your business forward. </p>
                    </div>
                </div>
            </div>
        </div>
