	...
	<div class="hb-bannerCont">
		<div class="hb-bannerImgCont">
			<div class="hb-bannerImg">
				...
				<picture>
					<source media="(max-width: 768px)" srcset="./pi-cloud/images/banners/professional-services.png">
					<img src="./pi-cloud/images/banners/professional-services.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%;">
				...
				<ul class="list-inline hb-JournLists">
					<li>
						<div class="hb-cuJoBox">
							...
							<h3>Foundation</h3>
							<p>Our expert architects assess your readiness, best practices, migration plan, tools, and technologies related to your enterprise's digital transformation goals.
							</p>
						</div>
					</li>
					<li>
						<div class="hb-cuJoBox">
							...
							<h3>Migration</h3>
							<p>Migrating workloads to the cloud allows enterprises to adopt new technologies faster while improving security & compliance.
							</p>
						</div>
					</li>
					<li>
						<div class="hb-cuJoBox">
							...
							<h3>Optimization</h3>
							<p>Continuous assessment and dipstick audits lead to effective gap analysis, process optimization, the implementation of cost control mechanisms, and industry best practices.
							</p>
						</div>
					</li>
					<li>
						<div class="hb-cuJoBox">
							...
							<h3>Operate </h3>
							<p>Time-tested and proven expertise in infrastructure automation and Multi Cloud environments ensure uninterrupted availability of a federated environment for enterprises.</p>
						</div>
					</li>
				</ul>
			</div>
		...
		<div class="hb-deContO">
			<div class="container">
				<div class="hb-jorInfo text-center">
					<h2 style="color:#fff !Important;">Journey with Pi Cloud Professional and Managed Services</h2>
