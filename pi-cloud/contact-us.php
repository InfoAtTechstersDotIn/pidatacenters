		...
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/contactus_mbanner.png" al>
			      <img  src="images/banners/contactus_banner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
					...
					<ul class="list-unstyled hb-addr_list">
						<li>
							<div class="hb-address">
								...
								<p class="hb-mail">
									<a href="mailto:info@pi-cloud.in">info@pi-cloud.in</a>
 ...
 -->								</p>
							...
							<div class="hb-address">
								...
								<p class="hb-mail">
									...
									<a href="tel:+91 8712630334">+91 8712630334</a>
								</p>
							</div>
						</li>
