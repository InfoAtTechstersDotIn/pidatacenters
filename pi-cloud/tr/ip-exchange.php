...
<style type="text/css">
	...
	.text-center_sk >h3 , .text-center_sk >p{
		text-align: center!important;
	}
	.text-center_sk >span{
...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="./harbour1/images/banners/ipx_mbanner.png">
			      <img  src="./harbour1/images/banners/ipx_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
	...
	<section id="hb_products_Lists">
		<div class="container">
			<div class="hb-productHead text-center">
				...
				<p>Internet Protocol (IP) Packet eXchange (IPX) network @Pi®️ is the interconnect for exchange of IP based traffic between customers of separate mobile and fixed operator as well as other types of service providers, via IP based Network-to-Network Interface(NNI).</p>
			</div>
				...
				<div id="outer" class="skltbs-theme-light" data-skeletabs='{ "startIndex": 2 }'>
			        <ul class="skltbs-tab-group list-inline text-center">
			          <li class="skltbs-tab-item current">
			            <button class="skltbs-tab tab-link" data-tab="tab-1">For Enterprises</button>
			          </li>
			          <li class="skltbs-tab-item">
			            <button class="skltbs-tab tab-link" data-tab="tab-2">For Patners</button>
			          </li>
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            		    <span>
			            			<img src="./harbour1/images/product-images/i1_img.png" alt="workspace">			       
     			                            </span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/i2_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            			<img src="./harbour1/images/product-images/i5_img.png" alt="workspace">	            		
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p>Each party is remunerated for the work they do to deliver packets over the wire. This business model works well as it encourages a healthy competition – each party is motivated to compete for the delivery of traffic. In this way, there is also an obligation for each party to deliver to a certain quality. This means an SLA is enforced.</p>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/ip2_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
