...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		...
		<!--	<picture>
			     <source media="(max-width: 768px)" srcset="./harbour1/images/banners/compute_banner.png">
			      <img  src="./harbour1/images/banners/compute_mbanner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>-->
      			<picture>
			     <source media="(max-width: 768px)" srcset="./<?= $config['subFolderName'] ?>/images/banners/compute-banner.jpg">
			      <img  src="./<?= $config['subFolderName'] ?>/images/banners/compute-banner.jpg" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
      		<h2>Private Cloud</h2>
		</div>		
	</div>
			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/vm_img.png" alt="tickmark">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="./harbour1/images/scale-3.svg" alt="scale">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="./harbour1/images/Economics.svg" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="./harbour1/images/Self.svg" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/containers_img.png" alt="workspace">
			            			</span>
