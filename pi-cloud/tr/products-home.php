   ...
   <div class="hb-bannerImgCont">
      <div class="hb-bannerImg">
         <picture>
            ...
            <img  src="./<?= $config['subFolderName'] ?>/images/banners/Products-new.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
         ...
         <div  class="ex-dept-Right" id="test">
            <ul class="list-inline ">
               <!--<li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/TopPicks.svg" alt="TopPicks"/></p>
                        <h2>Top Picks</h2>
               ...
               <!--<li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/Compute.svg" alt="Compute"/></p>
                        <h2>Compute </h2>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/Network.svg" alt="Network"/></p>
                        <h2>Network  </h2>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/Storage.svg" alt="Storage"/></p>
                        <h2>Storage  </h2>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/Security.svg" alt="Security"/></p>
               ...
               <!--<li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/SAP.svg" alt="SAP"/></p>
                        <h2>SAP on Cloud</h2>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/BCP.svg" alt="BCP"/></p>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/DevOps.svg" alt="DevOps"/></p>
                        <h2>DevOps  </h2>
                        <p class="hb-grHead"> HA | DR | People | Processes  </p>
                     </div>
                     <div class="full-cont hwi">
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     <div class="grid_view">
                        <p class="plus_ico"><img src="./harbour1/images/EUC.svg" alt="EUC"/></p>
