...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<!--<picture>
			     <source media="(max-width: 768px)" srcset="./harbour1/images/banners/network_mbanner.png">
			      <img  src="./harbour1/images/banners/network_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
      		<picture>-->
			     <source media="(max-width: 768px)" srcset="./<?= $config['subFolderName'] ?>/images/banners/network-banner.jpg">
			      <img  src="./<?= $config['subFolderName'] ?>/images/banners/network-banner.jpg" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
      			<h2>Network</h2>
		</div>		
	</div>
			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            		    <span>
			            			<img src="./harbour1/images/product-images/sdwan_img.png" alt="workspace">			       
     			                            </span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/mpls_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/directconnect_img.png" alt="workspace">			            		
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/wifioncloud_img.png" alt="workspace">			            			
							</span>
			            		</div>
			            	</li>
			          ...
			          <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/cdn_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			...
			            			<p>Harbourfront<sup>TM</sup><a href="https://harbour1.in/harbourfront-cdn">(CDN)</a>, India's first indigenous content service ensures high availability and performace. By geographically distributing a network of proxy servers and caching data spatially relative to end users, Harbourfront<sup>TM</sup>(CDN) ensures ensures high availability and performance. It can be used for content storage and delivery service for web acceleration, file download optimization, transcoding, video on demand and live streaming. <a href="/harbourfront-cdn" style="color: #fff;/* padding-left: 24px; */padding: 5px 10px;font-size: 14px;border-radius: 29px;background-color: #3d1b9b;">Learn More &gt;</a></p>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/lb_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			           ...
			           <div class="skltbs-panel" id="tab-3">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/vpn_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
