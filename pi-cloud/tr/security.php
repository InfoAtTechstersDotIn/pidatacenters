...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<!--<picture>
			     <source media="(max-width: 768px)" srcset="./harbour1/images/banners/cs_mbanner.png">
			      <img  src="./harbour1/images/banners/cs_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>-->
      		<picture>
			     <source media="(max-width: 768px)" srcset="./<?= $config['subFolderName'] ?>/images/banners/cyber-security-banner.jpg">
			      <img  src="./<?= $config['subFolderName'] ?>/images/banners/cyber-security-banner.jpg" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/firewall_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p>Anti-DDoS on Harbour1<sup>®</sup>, secures websites, applications, and entire network while ensuring the performance of legitimate traffic is not compromised. It is designed to protect enterprise network, transport and application Layer </p>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/ddos_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            </ul>
			          ...
			          <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            			<img src="./harbour1/images/product-images/av_img.png" alt="workspace">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			...
			            			<p>Being connected to internet also opens up avenues for increased threat vector. Harbour1<sup>®</sup> antivirus software scans for security and performance issues and ensures  enterprise systems, data and end-users are malware-safe and immune to the zero-day vulnerabilities. </p>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p>WAF service on Harbour1<sup>®</sup> monitors, logs and analyses the HTTP traffic between enterprise application and internet. It aims to protect against vulnerabilities in the application by filtering out malicious traffic. WAF on Harbour1<sup>®</sup> protects web applications from cross-site forgery, cross-site-scripting (XSS), file inclusion, and SQL injection, among others that may sabotage important transactions and steal sensitive data. </p>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/waf_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			           ...
			           <div class="skltbs-panel" id="tab-3">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/epp_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p>Reduce the time to detect and respond to threats with EDR on Harbour1<sup>®</sup>. It provides additional tools to hunt for threats, forensically analyse intrusions and respond swiftly and effectively to attacks. </p>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/iam_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			...
			            			<p>IAM on Harbour1<sup>®</sup> is a periphery security to the cloud. It acts as a foundation to a secured and fully compliant cloud architecture. Admins can create and manage end-users, groups, relative policies and use permissions to allow or deny their access . </p>
			           ...
			           <div class="skltbs-panel" id="tab-4">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/soc_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			...
			            			<p>Security Information and Event Management (SIEM) enabled SOC on Harbour1<sup>®</sup> is a centralized 24x7 function to continuously monitor and enhance the enterprise security posture for an organization, while preventing, detecting, analyzing, and responding to cybersecurity incidents. </p>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/vapt_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="./harbour1/images/product-images/vault_img.png" alt="workspace">
