		...
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/cstu_banner.png">
			      <img  src="images/banners/cstu_mbanner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
	...
	<div  class="hb-casePop">
		<div class="hb-dPop">
			...
			<div class="hb-cFormGroup">
				...
				<input type="submit" name="submit" value="Download Case Study" id="case-studes-submit-btn" class="hb-cseSub">
			</div>
		</form>
		</div>
	</div>
