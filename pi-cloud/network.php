						...
						<ul class="hb-productSec list-inline">
							...
							<li>
								<div class="hb-rightCont hb_ppCont">
									...
									<h5><strong>Dedicated connection from your premises to pi-cloud<sup>Â®</sup></strong></h5>
									<p>Seamless and secure Point to Point ethernet connection ensures your premise is directly connected to pi-cloud<sup>Â®</sup>. Enterprises can also establish private connectivity between pi-cloud<sup>Â®</sup> and their multi cloud environments. This ensures increased bandwidth throughput up to hundreds of Gigs to meet real-time spikes and eases the transfer of large data sets over the wire. </p>
								</div>
							</li>
							<li>
								<div class="hb-leftCont hb_ppCont">
						...
						<ul class="hb-productSec list-inline">
							...
							<li>
								<div class="hb-leftCont hb_ppCont">
									...
									<p>Enterprises can leverage pi-cloud<sup>Â®</sup> to distribute workloads and compute resources on hybrid and heterogeneous cloud environments. This service is adopted by enterprises to dynamically manage resource allocation and workload demands. Lower cost of ownership, ease of scale and manageability, are some of its key advantages over conventional on-premise load balancing . </p>
								</div>
							</li>
							<li>
								<div class="hb-rightCont hb_ppCont">
