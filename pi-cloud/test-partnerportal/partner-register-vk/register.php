...
<body>
    <p style="float:right;padding:4px"><a href="https://pidatacenters.com/" target="_blank"><img src="assets/images/logo3.png"></a></p><br>
    <div id="loader">
    ...
    <div class="VertiMidwerty">
        ...
        <div class="container-fluid">
            ...
            <div class="lft_crd">
                <img src="assets/images/left_crd_main.svg?vmay02" class="image-responsive">
            </div>
            ...
            <div class="cntr_crd" id="cntr_crd">
                ...
                <img src="assets/images/Group148-1.png?vmay02">
            </div>
            ...
            <div class="m_w_logo" id="m_w_logo">
                <img src="assets/images/main-logo.png?vmay02"><br>
                <button style=" margin: 10px 95px;color: white;background-color:#28a745;border: none;padding: 6px 10px;border-radius: 4px;">Login </button>
            </div>
            <div class="m_b_logo" id="m_b_logo">
                <img src="assets/images/PiPartnerProgramlogo.svg?vmay02" style="margin-top:28px !important;">
            </div>
