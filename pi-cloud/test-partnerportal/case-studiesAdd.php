                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                       <div class="form-group col-md-6 col-sm-12">
                        <label for="Objective">Case Study Title</label>
                        <input type="text" class="form-control calVal" id="title" Placeholder="Enter Case Study Title">
                      </div>
					  </div>
					  <div class="row">
                        <div class="form-group col-md-6 col-sm-12">
                        <label for="Audience">Case Study Decription</label>
                        <textarea class="form-control" id="Decription"></textarea>
						</div>
					</div>
					<div class="row">
                        <div class="form-group col-md-6 col-sm-12">
                        <label for="Audience">Case Study Date</label>
                        <input type="date" class="form-control" id="Decription">
						</div>
					</div>
					<div class="row">
                       <div class="form-group col-md-6 col-sm-12">
                        <label for="Audience sponsers">Case Study Image</label><br>
