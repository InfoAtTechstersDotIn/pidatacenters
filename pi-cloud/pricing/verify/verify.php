           ...
           $message='<p>Email Verification already done, Please login.</p>';
            ...
            if (mysqli_num_rows($res) > 0) {
                ...
                if($usermail == $dec_hashcode){
                    ...
                    $get_result = mysqli_query($mr_con,"UPDATE profiles SET is_email_verified = 1 WHERE user_id='$verifyid'");
...
<body>
    <div class="container">
        <header class="header">        
            <a class="logo" href="https://pidatacenters.com/"><img src="https://pidatacenters.com/wp-content/uploads/2017/12/Pi-Logo-180x80.png" alt="Pi Logo"></a>
        </header>
