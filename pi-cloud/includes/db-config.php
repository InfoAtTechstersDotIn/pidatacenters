...
header("Content-Type: text/html; charset=ISO-8859-1");
 ...
 class Databases{  
      ...
      {  
           $this->con = mysqli_connect("localhost", "harbourdash", "Iaa4oubsCnitLVrH", "pi-cloud");  
           if(!$this->con)  
           {  
      ...
      {  
           $array = array();  
           $query = "SELECT * FROM ".$table_name." WHERE status = 1 and cat_id =".$cat_id." ORDER by id DESC";  
      ...
      //Select posts with limit
      public function selectLimit($table_name, $cat_id, $limit)  
      {  
           $array = array();  
           $query = "SELECT * FROM ".$table_name." WHERE status = 1 and cat_id =".$cat_id." ORDER by id DESC LIMIT ".$limit;  
           $result = mysqli_query($this->con, $query);  
           while($row = mysqli_fetch_assoc($result))  
           {  
                $array[] = $row;  
