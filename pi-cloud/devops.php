...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<!--<picture>
			     <source media="(max-width: 768px)" srcset="./pi-cloud/images/banners/devops_mbanner.png">
			      <img  src="./pi-cloud/images/banners/devops_banner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>-->
      			<picture>
			     <source media="(max-width: 768px)" srcset="./<?= $config['subFolderName'] ?>/images/banners/devops-banner.jpg">
			      <img  src="./<?= $config['subFolderName'] ?>/images/banners/devops-banner.jpg" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
      		<h2>DevOps</h2>
		</div>		
	</div>
	...
	<section id="hb_products_Lists">
		<div class="container">
			<div class="hb-productHead text-center">
				<h1>End-to-end DevOps solution on pi-cloud<sup>®</sup></h1>
				<p>DevOps is a portmanteau of “development & operations”, it is also a union of best practices and tools which are put in place to improve enterprise performance to deliver applications, products, and services faster. This agility empowers enterprises to serve their clients better and be competitive in the market. DevOps practice on pi-cloud<sup>®</sup>  eliminates the barriers between development and operations team. Under its unified model, development and operations team work collectively all through the software application life cycle, starting from testing an application to launching it.</p>
			</div>
