			...
			<ul class="list-inline hb-JournLists">
				<li>
					<div class="hb-cuJoBox">
						<span>	
							<img src="./pi-cloud/images/menu-icons/foundation_ico.svg" alt="journey">
						</span>
						<h3>Foundation</h3>
				...
				<li>
					<div class="hb-cuJoBox">
						<span>	
							<img src="./pi-cloud/images/menu-icons/migration_ico.svg" alt="journey">
				...
				<li>
					<div class="hb-cuJoBox">
						<span>	
							<img src="./pi-cloud/images/menu-icons/operate_ico.svg" alt="journey">
				...
				<li>
					<div class="hb-cuJoBox">
						<span>	
							<img src="./pi-cloud/images/menu-icons/optimize_ico.svg" alt="journey">
