                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="o_czipcode" placeholder="Zip/Postal Code" style="margin-top:24px;">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
