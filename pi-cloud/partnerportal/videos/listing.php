...
<div class="main-panel" id="page-kc-videos-listing">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-12 col-12 table-responsive">
              <table id="table-kc-videos" class="table table table-hover table-bordered" width="100%">
                <thead>
                  <tr class="table-row">
                    <th class="th-sm">S.NO</th>
                    <th class="th-sm">Title</th>
                    <th class="th-sm">Video URL Link</th>
