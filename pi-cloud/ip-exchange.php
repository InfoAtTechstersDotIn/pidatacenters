			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            		    <span>
			            			<img src="./pi-cloud/images/product-images/i1_img.png" alt="workspace">			       
     			                            </span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./pi-cloud/images/product-images/i2_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            			<img src="./pi-cloud/images/product-images/i5_img.png" alt="workspace">	            		
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="./pi-cloud/images/product-images/ip2_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
