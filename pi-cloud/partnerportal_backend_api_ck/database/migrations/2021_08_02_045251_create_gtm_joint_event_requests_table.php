...
class CreateGtmJointEventRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gtm_joint_event_requests', function (Blueprint $table) {
            $table->id();
           ...
           // $table->text('partner_ownership');
            ...
            //$table->float('fund_requested', 15, 2);
            $table->text('comments');
            ...
            $table->text('loc_covered');
            $table->text('social_media');
            $table->text('print_media');
            $table->text('institutional_building');
    ...
    {
        Schema::dropIfExists('gtm_joint_event_requests');
    }
}
