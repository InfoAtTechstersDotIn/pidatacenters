		...
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/blog_mbanner.png">
			      <img  src="images/banners/blog_banner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
        ...
        ?>  
			<li  class="hb-blogBox">
				<div class="hb-blogBoxCont" >
					<div class="hb-blogIm">
						<p>
						<img src="https://pi-cloud.in/dashboard/public/imgs/<?php echo $post["thumb"]; ?>" alt="blog1">
					</p>
					</div>
					<div class="hb-blogBoxInfo">
						...
						<div class="hb-blogClick  ">
							<a href="./blog-info/<?php echo $post["id"]; ?>/<?php echo $data->create_slug($post["title"]) ?>" class="global-button">Read More</a>
						</div>
					</div>
				</div>
			</li>
