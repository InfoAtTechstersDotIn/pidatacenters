	...
	<section id="hb_products_Lists">
		<div class="container">
			<div class="hb-productHead text-center">
				<h1>Go practically limitless capacity with pi-cloud<sup>®</sup> </h1>
				<p>Data is the lifeline of any business and it is important to consider how enterprises store data, based on enterprise business needs.  pi-cloud<sup>®</sup> allows enterprises to select storage of choice that meets business objectives. pi-cloud<sup>®</sup> presents varied storage formats to hold, organize and present data with objective driven distinct features and capabilities.</p>
			</div>
			            ...
			            <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<h3>Block Storage</h3>
			            			<p>This allows enterprises to store data into blocks and then store them with unique identifiers. Block storage on pi-cloud<sup>®</sup> offers durable, customizable block volumes, attached to virtual servers. Ease of manageability and  customization makes them stand out. </p>
			            		</div>
			            	</li>
			            </ul>
			          ...
			          <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			...
			            			<p> Today’s digital world requires data archiving and backing-up of unstructured data. Media and web contents like email, videos, image files, web pages and sensor data produced by IoT has taken the center stage. Object storage on pi-cloud<sup>®</sup> is ideal for archiving data that does not change frequently. </p>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            ...
			            <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<h3>File Storage</h3>
			            			<p>A hierarchical storage methodology used to organize and store data on a incompute storage or network-attached storage. File storage on pi-cloud<sup>®</sup> is a Linux file system, and is the predominant human-readable storage format. </p>
			            		</div>
			            	</li>
			            </ul>
			            <div class="hb-features">
