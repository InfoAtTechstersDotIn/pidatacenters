...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=BASE_URL?>assets/vendors/fontawesome/css/all.css" />
    <link rel="stylesheet" type="text/css" href="<?=BASE_URL?>assets/vendors/inteltelinputs/build/css/intlTelInput.min.css?vmay02" />
    <link rel="stylesheet" type="text/css" href="<?=BASE_URL?>assets/css/shared/partner-register-styles.css" />

</head>

<body>
<p style="float:right;"><a href="https://pidatacenters.com/" target="_blank"><img src="<?=BASE_URL?>assets/images/logo3.png" style="width:135px;"></a></p>
    <br/>
    <div id="loader">
...
<div class="VertiMidwerty" >
    <div class="container-fluid">
        <div class="lft_crd">
            <img src="<?=BASE_URL?>assets/images/partner-register/left_crd_main.svg?vmay02" class="image-responsive">
        </div>
        <div class="lft_crd_wt">
            <!--<img src="<?=BASE_URL?>assets/images/partner-register/cntr_wtcrd.svg?vmay02" class="image-responsive">-->
		<img src="<?=BASE_URL?>assets/images/partner-register/cntr_wtcrd-1.png" class="image-responsive"> 
        </div>
        <!--<div class="cover_layer"></div>-->
        <div class="cntr_crd" id="cntr_crd">
            <img src="<?=BASE_URL?>assets/images/partner-register/Group148-1.png?vmay02">
        </div>

        <div class="m_logo" id="m_logo">
            <img src="<?=BASE_URL?>assets/images/partner-register/PiPartnerProgramlogo.svg?vmay02">
        </div>
        <div class="m_w_logo" id="m_w_logo">
            <img src="<?=BASE_URL?>assets/images/partner-register/main-logo.png?vmay02">
	    <br/>
            <a href="<?=BASE_URL?>login" ><button style=" margin: 10px 95px;color: white;background-color:#28a745;border: none;padding: 6px 10px;border-radius: 4px;">Login <i class="fas fa-arrow-right" style="color:white;"></i></button>
            <i class="fas fa-arrow-right" style="color:white;"></i></a>
        </div>
        <div class="m_b_logo" id="m_b_logo">
            <img src="<?=BASE_URL?>assets/images/partner-register/PiPartnerProgramlogo.svg?vmay02">
        </div>
        <div class="mob_white_fav">
            <img src="<?=BASE_URL?>assets/images/partner-register/PiPartnerProgram%20Logo-whitelogo-02.png?vmay02">
        </div>
        ...
        <div class="letter_cont">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item current">
                    <a class="nav-link active" id="home_header" data-toggle="tab" href="#home_tab" role="tab"
                        aria-controls="home_tab" aria-selected="true">Home</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" id="personal_header" data-toggle="tab" href="#profile_tab" role="tab"
                        aria-controls="profile_tab" aria-selected="false">Personal Information</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="organisation_header" data-toggle="tab" href="#organisation_tab" role="tab"
                        aria-controls="organisation_tab" aria-selected="false">Organisation Details</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="Technical_header" data-toggle="tab" href="#Technical_tab" role="tab"
                        aria-controls="Technical_tab" aria-selected="false">Technical Information</a>
                </li>
                <li class="nav-item">
                    ...
                    <a class="nav-link" id="Business_header" data-toggle="tab" href="#Business_tab" role="tab"
                        aria-controls="Business_tab" aria-selected="false">Business Case</a>
                </li>
            </ul>

            <div class="wt_crd">
		<form id="frm-part-reg">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="home_tab" role="tabpanel" aria-labelledby="home-tab">
                        <div class="container-fluid">
                            ...
                            <p class="lht_2rem"><i><small>
                                ...
                                <a href="#" class="btn btn-success get_profile_tab flt_rt m-r-10">Register
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="p_bemail"
                            ...
                            <div class="text-right m-r-20 m-t-10 mob_m_t_10">
                                <a href="#" class="btn btn-primary get_home_tab"><i class="fas fa-arrow-left"></i>
                                    Back</a>
                                <a href="#" class="btn btn-success get_organisation_tab tab_next"
                                    id="btnFirstForm">Continue
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="organisation_tab" role="tabpanel"
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="o_cwebsite"
                                            placeholder="Company Website">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Company Description<small class="text-danger">(max. 1000 chars)</small></label>
                                        <input type="text" class="form-control resize_none"
                                            placeholder="Company Description" id="o_cdesc" data-toggle="tooltip"
                                            data-placement="top" data-original-title="company Description" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Company Headquarters Address<small class="text-danger">(max. 255 chars)</small></label>
                                        <input type="text" class="form-control" id="o_chq"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="o_czipcode"
                                            placeholder="Zip/Postal Code" style="margin-top:24px;">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Country <small style="font-size:">(Select from the dropdown list only)</small></label>
                                        <div class="dropdown">

                                            <input type="text" class="form-control" id="countrydd"
                                                onkeyup="countriesfilterFunction()" placeholder="Select from the list">
                                            <div class="dropdown-menu ht_200 wd-102pc" id="countries_dropdown"
                                                style="width: 105%">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>State <small>(Select from the dropdown list only)</small></label>
                                        <input type="text" class="form-control o_csr_state" id="o_cspr"
                                            placeholder="Select from the list">
                                        <div class="dropdown dsp_none o_csr_state">
                                            <input type="text" class="form-control" id="o_cspr_sind"
                                                onkeyup="indiafilterFunction()" placeholder="Select from the list">

                                            <div class="dropdown-menu  ht_200" aria-labelledby="o_cspr_sind"
                                                id="indiastate_dropdown">
                                        ...
                                        <div class="dropdown dsp_none o_csr_state">
                                            ...
                                            <input type="text" class="form-control" id="o_cspr_susa"
                                                onkeyup="usafilterFunction()" placeholder="Select from the list">
                                            <div class="dropdown-menu menu_text_select ht_200"
                                                aria-labelledby="o_cspr_susa" id="usastate_dropdown">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>City<small>(Select from the dropdown list only)</small></label>
                                        <div class="dropdown">
                                            ...
                                            <!--                                       <div class=" right-addon">-->
                                            <input type="text" class="form-control" id="o_city" onkeyup="cityfilterFunction()"
                                                placeholder="Select from the list">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="o_arevenue"
                                            placeholder="Annual Revenue (INR Crs)">
                                    </div>
                                </div>
                                ...
                                <div id="dvlob_other_input" class="col-md-12 m-b-20" style="display: none">
                                    <input type="text" id="lob_other_input" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class=" right-addon">
                                                <input type="text" class="form-control" id="o_relowner"
                                                    onkeyup="rofilterFunction()" placeholder="Select from the list">
                                                <i class="fa fa-caret-down" style="float: right;
                                     top: 10px;
                                     position: absolute;
                                     right: 10px;"></i>
                                            </div>
                                            <div class="dropdown-menu " aria-labelledby="empstrength"
                                                id="relowner_dropdown">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="dropdown dropup">
                                            <input type="text" class="form-control" id="loc_o_b"
                                                onkeyup="locofb_filterFunction()" placeholder="Select from the list">
                                            <ul class="dropdown-menu dropup-content multi-level ht_300 ul_lop"
                                                id="locofbusinees_dropdown">
                                                <li class="dropdown-submenu">
                                                    <a class="dropdown-item ds-selected" href="#">India</a>
                                                    <ul class="dropdown-menu" id="india_states">
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Andhra Pradesh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Arunachal Pradesh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Assam</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Bihar</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Chhattisgarh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Goa</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Gujarat</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Haryana</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Himachal Pradesh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Jammu and Kashmir</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Jharkhand</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Karnataka</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Kerala</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Madhya Pradesh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Maharashtra</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Manipur</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Meghalaya</a></li>
                                                        ...
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Sikkim</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Tamil Nadu</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Telangana</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Tripura</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Uttarakhand</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Uttar Pradesh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a href="#">West
                                                                Bengal</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Andaman and Nicobar Islands</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Chandigarh</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Dadra and Nagar Haveli</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Daman and Diu</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Delhi</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Lakshadweep</a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Puducherry</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="dropdown-submenu ">
                                                    ...
                                                    <ul class="dropdown-menu" id="us_states">
                                                        ...
                                                        <li class="dropdown-item dropdown-submenu-item"><a href="#">New
                                                                York </a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">North Carolina </a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">North Dakota </a></li>
                                                        ...
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Pennsylvania Rhode Island </a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">South Carolina </a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">South Dakota </a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                                href="#">Tennessee
                                                            </a></li>
                                                        <li class="dropdown-item dropdown-submenu-item"><a
                                                ...
                                                <li class="dropdown-item dropdown-menu-item"><a
                                                        href="#">Guinea-Bissau</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group flt_rt slctall_stls">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="tc_selall"
                                                value="Select All" id="tc_selall">
                                            ...
                                            <tr>
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="tc_edu">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="tar_cli_base" value="Education" id="tc_edu">
                                                                Education
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_base" value="Enterprise" id="tc_ent">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_base" value="Government-Local" id="tc_gl">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_base" value="Government-National"
                                                                id="tc_gn">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_base" value="Mid-size Business"
                                                                id="tc_msb">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_base" value="Non-Profit" id="tc_np">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_base" value="Startup" id="tc_stp">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tar_cli_basee" value="Others" id="tc_otherr">
                                ...
                                <div class="col-md-12 m-b-20">
                                    <input type="text" class="form-control dsp_none" placeholder="Please mention here"
                                        id="tc_other_input">
                                </div>
                    ...
                    <div class="tab-pane fade" id="Technical_tab" role="tabpanel"
                        ...
                        <div class="container-fluid">
                            <div class="row" id="Technical_tab_div">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group flt_rt slctall_stls">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="" value="Select All"
                                                id="uce_selall">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Cloud Services" id="uce_cs">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Data Center Services"
                                                                id="uce_dcs">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Disaster Recovery"
                                                                id="uce_dr">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Business Applications - SAP"
                                                                id="uce_bsap">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe"
                                                                value="Business Applications - Microsoft" id="uce_bmic">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe"
                                                                value="Business Applications - Oracle" id="uce_bocl">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Business Applications - Other"
                                                                id="uce_botr">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe"
                                                                value="Big Data, Analytics, Batch Processing &amp; Business Intelligence (BI)"
                                                                id="uce_bi">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Archieving" id="uce_arch">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="High Availability"
                                                                id="uce_havai">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Content Delivery"
                                                                id="uce_contdel">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe"
                                                                value=" Database &amp; Data Warehouse" id="uce_dbdw">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value=" Dev &amp; Test"
                                                                id="uce_devt">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Digital Marketing"
                                                                id="uce_digimark">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe"
                                                                value="High Performance Computing (HPC)" id="uce_hpc">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Internet of Things (IoT)"
                                                                id="uce_IOT">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Mobile" maxlength="10"
                                                                id="uce_mobile">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Security &amp; Compliance"
                                                                id="uce_seccomp">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe"
                                                                value="Storage (Backup, Recovery &amp; Asset Storage)"
                                                                id="uce_storage">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Value (Cost Saving / TCO)"
                                                                id="uce_value">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expe" value="Web &amp; Web Apps"
                                                                id="uce_webapps">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="u_case_expee" value="Others" id="uce_otherr">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Apache" id="te_apache">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value=" Flash Media Server"
                                                                id="te_fms">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Hadoop" id="te_hadoop">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="IBM" id="te_ibm">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="JBOSS" id="te_jboss">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Linux" id="te_linux">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value=".NET" id="te_mnet">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="MS Exchange" id="te_mexc">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value=" Microsoft Share Point"
                                                                id="te_msp">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="MS SQL" id="te_msql">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="MySQL" id="te_mysql">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="SAP" id="te_sap">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="SAP" id="te_saphana">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Oracle Apps" id="te_oapps">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Oracle DataBase" id="te_odb">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Oracle Middleware"
                                                                id="te_omidware">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="Ruby on Rails" id="te_ruby">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="System Management"
                                                                id="te_sysmgnt">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expe" value="System Integration"
                                                                id="te_sysint">
                                                            <label class="form-check-label" for="te_sysint">
                                                                System Integration
                                                            </label>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="tech_expee" value="Others" id="te_othh">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group flt_rt slctall_stls">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pso_selall"
                                                value="Select All" id="pso_selall">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="Assessments" id="pso_asses">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="ERP Consulting" id="pso_erp">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="Cloud Migration Services"
                                                                id="pso_cms">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off"
                                                                value="Custom Application Development" id="pso_cad">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="Digital Marketing"
                                                                id="pso_dism">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="Managed Service Provider"
                                                                id="pso_msp">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="Strategic / IT Consulting"
                                                                id="pso_sitc">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_off" value="Staff Augmentation"
                                                                id="pso_stfaug">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="prof_ser_offf" value="Others" id="pso_othee">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label><b>Interested Services/Products @Pi<sup>®</sup></b> <small
                                            class="text-danger">(Please
                                            select all that apply)</small></label>
                                    <div class="form-group flt_rt slctall_stls">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="isp_selall"
                                                value="Select All" id="isp_selall">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_prov" value="Co-Location" id="isp_colo">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_prov" value="Cloud Services"
                                                                id="isp_clos">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_prov" value="Managed Services"
                                                                id="isp_mans">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_prov" value=" Data Center Build"
                                                                id="isp_dcb">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_prov" value=" Data Center Consulting"
                                                                id="isp_dcc">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_prov" value="Assessments" id="isp_asses">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="int_ser_provv" value="Others" id="isp_othh">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control resize_none" id="b_brieftxt" rows="6"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <label class="checkbox-inline col-md-4">
                                                <input type="checkbox" value="Recurring Commission"
                                                    name="partnership_model" class="partnership_model">Recurring Commission <b class="fa fa-info-circle"
                                                    class="fa fa-info-circle" id="com" data-toggle="tooltip"
                                                    data-placement="right"
                                                    title="The registered business partner, in this model, is eligible for a recurring commission, payable on the revenue realized for each order from a qualified customer, through the partner. 
                                            The payout is basis the commission structure defined in Pi’s Registered Business Partner Program Agreement."></b>
                                            </label>
                                            <label class="checkbox-inline col-md-4">
                                                <input type="checkbox" value="One-Time Referral Bonus" name="partnership_model"
                                                    class="partnership_model"> One-Time Referral Bonus <b
                                                    class="fa fa-info-circle" class="fa fa-info-circle" id="tp"
                                                    data-toggle="tooltip" data-placement="right"
                                                    title="The registered business partner, in this case shall get a transfer price from Pi. The partner is free to add its own margin as appropriate, over and above the transfer price and position the services to its customers, accordingly.
                                          The transfer price shall be discussed and agreed on case to case basis between Pi and the Partner."></b>
                                            </label>
                                            <label class="checkbox-inline col-md-3">
                                                <input type="checkbox" value="Transfer Price" name="partnership_model"
                                                    class="partnership_model"> Transfer Price <b
                                                    class="fa fa-info-circle" class="fa fa-info-circle" id="tp"
                                                    data-toggle="tooltip" data-placement="right"
                                                    title="The registered business partner, in this case shall get a transfer price from Pi. The partner is free to add its own margin as appropriate, over and above the transfer price and position the services to its customers, accordingly.
                                          The transfer price shall be discussed and agreed on case to case basis between Pi and the Partner."></b>
			    ...
			    <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Upload RBPP Agreement 
                                            <small class="text-danger">(must be a pdf file with size up to 4MB)</small>
                                        </label>
                                        <input type="file" name="agreement_doc" id="agreement_doc" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <input type="file" name="nda" id="nda" required />
                                    </div>
                                </div>
                            </div>
                            <div class="text-right m-r-20 mob_m_t_10">
		...
		<div class="container-fluid" style="text-align:center;"><span  style="color:red; font-size:10px;">*All fields in this application are mandatory</span></div>
		</form>
            </div>
    ...
    <script src="<?=BASE_URL?>assets/vendors/jquery/jquery.min.js?v4"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js"
        crossorigin="anonymous"></script>
    <script src="<?=BASE_URL?>assets/vendors/bootstrap/bootstrap.min.js?v4"></script>
    <script src="<?=BASE_URL?>assets/vendors/inteltelinputs/build/js/intlTelInput-jquery.min.js?v5"></script>
    <script src="<?=BASE_URL?>assets/js/theme/scripts.js?v2525"></script>
    <script>
