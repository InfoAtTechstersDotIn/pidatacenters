		...
		<div class="row page-title-header">
            <div class="col-12">
              <div class="page-header">
                <h4 class="page-title">New Registrations</h4>
              </div>
            </div>
        </div>
        		...
        		<table id="pending-registrtaion" class="table table table-hover  table-bordered" width="100%">
				  <thead>
				    <tr>
				      ...
				      <th class="th-sm" colspan="2"> Approve / Reject </th>
				      <th class="th-sm"> Generate Certificate </th>
				      <th class="th-sm"> Download Certificate <br/><span style="font-size:10px;">(Link available only if certificate already generated)</span></th>
				    </tr>
				  </thead>
				  <tbody>
				</table>
