...
<html lang="en">
   <head>
      <title>pi-cloud® | Products</title>
      <meta charset="utf-8">
      <meta http-equiv="x-ua-compatible" content="ie=edge">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <link rel="icon" href="http://103.210.73.84/pi-cloud-homepage/images/H1 logo 1000x1000.png">
   ...
   <body>
      ...
      <header>
         <div class="hb-headCount">
            <div class="hb-logo">
               <a href="/">
               <img src="http://pi-cloud.in/images/harbour_logo.png" align="pi-cloud®" alt="pi-cloud®">
               </a>
            </div>
            ...
            <div class="hb-bannerCont">
                  <div class="hb-bannerImgCont">
                        <div class="hb-bannerImg">
                              <picture>
                               <source media="(max-width: 767px)" srcset="../imges/pi-cloud_Banner_2020_2b_780x840.png?v10">
                                    <img  src="images/product-Banner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
                              </picture>
                        </div>
                           ...
                           <div class="full-cont hwi">
                              ...
                              <ul class="list-inline child_deptCont">
                                 ...
                                 <li>
                                  ...
                                  <li>
                                    <h3>pi-cloud @ The Edge</h3>
                                    <p>Bring the agility and innovation of pi-cloud closer to last mile</p>
                                 </li>
                              </ul>
                           </div>
                        </div>
                        ...
                        <div class="dept-list">
                           ...
                           <div class="full-cont hwi">
                              ...
                              <ul class="list-inline child_deptCont">
                                 ...
                                 <li>
                                    <h3>pi-cloud On-Premise</h3>
                                    <p>Run pi-cloud infrastructure and services at your premises for a truly consistent hybrid experience</p>
                                 </li>
                                 <li>
                                    <h3>pi-cloud @ The Edge (CTA)</h3>
                                    <p>Bring the agility and innovation of pi-cloud closer  to last mile</p>
                                 </li>
                              </ul>
                           </div>
                           ...
                           <div class="full-cont hwi">
                              ...
                              <ul class="list-inline child_deptCont">
                                 ...
                                 <li>
                                    ...
                                    <p>Encrypted IPsec connections between a local data center and pi-cloud® VPC</p>
                                 </li>
                                 <li>
                                    <h3>SD-WAN</h3>
                                 ...
                                 <li>
                                    <h3>P2P Connect</h3>
                                    <p>Establish a dedicated network connection from your premises to pi-cloud</p>
                                 </li>
                                 <li>
                                    <h3>Wifi on Cloud</h3>
                                    <p>Manage enterprise-grade Wi-Fi networks across sites on pi-cloud</p>
                                 </li>
                              </ul>
                           </div>
                        </div>
