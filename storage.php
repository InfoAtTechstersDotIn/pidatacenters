...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			...
			<picture>
				<source media="(max-width: 768px)" srcset="./pi-cloud/images/banners/storage-banner.jpg">
				<img src="./pi-cloud/images/banners/storage-banner.jpg" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
			</picture>
			<h1>Storage</h1>
		</div>
	</div>
						...
						<ul class="hb-productSec list-inline">
							...
							<li>
								<div class="hb-rightCont hb_ppCont">
									<h3>Block Storage</h3>
									<p class="para-color">This allows enterprises to store data into blocks and then store them with unique identifiers. Block storage on Pi Cloud offers durable, customizable block volumes, attached to virtual servers. Ease of manageability and customization makes them stand out. </p>
								</div>
							</li>
						</ul>
						...
						<ul class="hb-productSec list-inline">
							<li>
								<div class="hb-leftCont hb_ppCont">
									...
									<p class="para-color"> Today’s digital world requires data archiving and backing-up of unstructured data. Media and web contents like email, videos, image files, web pages and sensor data produced by IoT has taken the center stage. Object storage on Pi Cloud is ideal for archiving data that does not change frequently. </p>
								</div>
							</li>
							<li>
								<div class="hb-rightCont hb_ppCont">
					...
					<div class="skltbs-panel  " id="tab-3">
						<ul class="hb-productSec list-inline">
							...
							<li>
								<div class="hb-rightCont hb_ppCont">
									<h3>File Storage</h3>
									<p class="para-color">A hierarchical storage methodology used to organize and store data on a incompute storage or network-attached storage. File storage on Pi Cloud is a Linux file system, and is the predominant human-readable storage format. </p>
								</div>
							</li>
						</ul>
						<div class="hb-features">
