...
-->
                           ...
                           <li >
                             ...
                             <a href="JavaScript:void(0);" class=" drop-arrow">PRODUCTS</a>
                                        <div class="drop-down">
                                        <ul>
                                             <li ><a href="./pi-cloud/security"  target="_blank">Cyber Security</a></li>
                                             <li ><a href="./pi-cloud/ip-exchange" target="_blank">Internet Exchange (IPX)</a></li>
                                   <li>
...
<!--		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Public Cloud Support</a></li>-->
 ...
 <li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="JavaScript:void(0);" class="menu-link sub-menu-link">SERVICES</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
		<li id="nav-menu-item-3869" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://pi-cloud.in/security" class="menu-link sub-menu-link" >Cyber Security</a></li>
<!--		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Public Cloud Support</a></li>-->
		<li id="nav-menu-item-3871" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://pi-cloud.in/ip-exchange" class="menu-link sub-menu-link">Internet Exchange (IPX)</a></li>
...
<h3>Cyber Security</h3>
                   ...
                   <div>
                       ...
                       <li class="col-md-4">
                         ...
                         <div class="know-more">
                             <a href="./pi-cloud/compute" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                        <li class="col-md-4">
                       ...
                       <li class="col-md-4">
                           ...
                           <h3>Storage as a Service </h3>
                             ...
                             <a href="./pi-cloud/storage" class="dc" target="_blank">Know More</a>
                                ...
                                <!--<div class="know-more">
                                    <a href="https://pi-cloud.in/" class="dc" target="_blank">Know More</a>
                                </div>-->
                            </div>
...
<li><a href="https://api.whatsapp.com/send?phone=+918978517793&amp;text=Hi, I need more information on Pidatacenters" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true" style="background:#00a82d;color:white"></i></a></li>
                   ...
                   <div class="col-md-5 top-foot">
                    ...
                    <li>
                      <a href="https://pi-cloud.in/partners" >Partners</a>
                    </li>
                      <li>
