          ...
          <div class="board-of-directors">
              <div class="container">
                  <div class="board-of-directors-main">
                        ...
                        <li class="col-md-3">
                          ...
                          <li class="col-md-3">
                            <div class="board-of-directors-in">
                                ...
                                <h4>Sridhar Gadhi</h4>
                                <p>Co-Chairman, Founder, and CEO, Quantela</p>
                                 <div class="linked-in-icon">
                      ...
                      <ul class="row slider certifications-mbl">
                        <li class="col-md-3">
                            <div class="board-of-directors-in">
                                 <img src="images/kiran-bd.png" alt="director-1" width="284" height="284">
                                <h4>Kalyan Muppaneni</h4>
                      ...
                      <ul class="row certifications-mbl slider">
                        <li class="">
                            <div class="board-of-directors-in">
                                 <img src="images/kalyan-scc.jpg" alt="director-img-1" width="186" height="76" class="modal-btn">
                                <h4>Kalyan Muppaneni</h4>
          ...
          <div class="board-of-directors">
              <div class="container">
                  <div class="board-of-directors-main board2">
                      ...
                      <ul class="row slider1 certifications-mbl">
                        <li class="">
                            <div class="board-of-directors-management">
                                 <img src="images/kalyan-mc.jpg" alt="management-1" width="525" height="580">
                                <h4>Kalyan Muppaneni</h4>
    ...
    <div class="modal-body">
      <div class="director-cnt row">
          <div class="director-lt col-md-4">
             <img src="images/management-1.png" alt="management-1" width="525" height="580">
...
<div id="modal-2" class="modalDialog">
    ...
    <div class="modal-body">
      <div class="director-cnt row">
          <div class="director-lt col-md-4">
             <img src="images/mangement-2.png" alt="management-2" width="525" height="580">
              <div class="director-lt-cnt">
                  <h3>Manu Sharma</h3>
                  <p>Chief Financial Officer</p>
                  <ul class="row social-icons">
    ...
    <div class="modal-body">
      <div class="director-cnt row">
          <div class="director-lt col-md-4">
             <img src="images/mangement-3.png" alt="management-2" width="525" height="580">
              <div class="director-lt-cnt">
                  <h3>Debmalya Dey Roy (Deb)</h3>
                  <p>Chief Revenue Office <br> & Global Marketing Head</p>
                  <ul class="row social-icons">
                                    <li class="col-4">
                                        <a href="#">
                                            <i class="fa fa-twitter" aria-hidden="true"></i>
 ...
 <div id="modal-4" class="modalDialog">
    ...
    <div class="modal-body">
      <div class="director-cnt row">
          <div class="director-lt col-md-4">
             <img src="images/mangement-4.png" alt="management-4" width="525" height="580">
              <div class="director-lt-cnt">
