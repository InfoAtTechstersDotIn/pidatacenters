...
if(isset($_POST['submit'])) {
    ...
    try {
      ...
      $mail->isHTML(true);
      $mail->Subject = 'Mail from Whitepapers from website';
      $mail->Body = $message;
...
?>
                  <div class="button">
                      <a href="dashboard/uploads/whitepapers/<?php echo $row->banner;?>" download>Download Now</a> &nbsp;
                        <a href="https://pidatacenters.com/whitepapers" >For More whitepapers</a>
                      </div>
