...
?>
                     ...
                     <ul class="slider certifications-mbl">
                      ...
                      <div class="tabBlock-pane">
                         <p>Recognized as one of the leading Data Center service providers across the globe, Pi DATACENTERS®  is a renowned organization within the Cloud & DC Infrastructure community. </p>
                         <ul class="row certifications-desktop">
                            ...
                            <li class="col-md-4">
                              ...
                              <li class="col-md-4">
                                  <div class="hover-award rec">
                                    ...
                                    <p>One Of India’s Top 50 IT Companies To Work With</p>
                                </div>
                                <figure>
                              ...
                              <li class="col-md-4">
                                ...
                                <figure>
                                 ...
                                 <li class="col-md-4">
                                     <div class="hover-award rec">
                                    <h5>Recognized By GPTW</h5>
                                    <p>One Of India’s Best Mid-Sized Organizations</p>
                                </div>
                                <figure>
