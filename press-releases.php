<?php
$seo_title = "News & Updates: Latest Press Releases";
$seo_description = "Find the latest press releases and news updates";
$seo_keywords = "News,press release, latest update";
?>
      ...
      <div class="article-blk-latest row">
        <div class="article-blk-latest-left col-md-9">
          <div class="latest-block">
            <div class="latest-block-left big-head">
              <img src="images/press/Press-news-11.jpg" alt="article-img-2" width="430" height="278">
              <span>21 September, 2023</span>
              <h2>Pi DATACENTERS&#174 Inaugurates Its Headquarters in Hyderabad's Financial District. </h2>
        ...
        <div class="article-blk-latest-right col-md-3">
          ...
          <div class="new-tranding row">
            <div class="new-tranding-lt col-md-12">
              <img src="images/press/press-news-1.jpg" alt="press-news-2" width="1280" height="670">
            </div>
      ...
      <ul class="row">
        <li class="col-md-4">
          <div class="latest-block">
            ...
            <h2>Pi Continues to be a Great Place to Work&#174;</h2>
        ...
        <li class="col-md-4">
          <div class="latest-block">
            ...
            <h2>Economic Times featured a recent interview of Kalyan Muppaneni about India achieving the goal of $5 trillion economy</h2>
        ...
        <li class="col-md-4">
          <div class="latest-block">
            ...
            <h2>Kalyan Muppaneni, Founder & CEO, Pi explains how the captive model of data center in India is being overtaken by colocation model at a significant rate</h2>
        ...
        <li class="col-md-4">
          <div class="latest-block">
            ...
            <h2>Great Place To Work&#174; Institute Recognized Pi As One Of The Top 50 Great Mid-Size Workplaces in India !</h2>
        ...
        <li class="col-md-4">
          <div class="latest-block">
            ...
            <h2>DatacenterDynamics (DCD) Recognized Pi As India&#8217s Best Multi-Tenant Data Center Service Provider !</h2>
