...
$r="SELECT * from whitepapers where id= '$todo'";
...
<div class="col-md-6">
  <figure>
                                    <img src="dashboard/uploads/whitepapers/<?php echo $row ->thumbfile; ?>" alt="case-studies-1" width="450" height="248" style="width:285px;height:215px;margin:0 auto;">
                                </figure>
</div>
					<div class="write-to-us-rt col-md-6">
						  <!--<h2>Fill Your Details</h2>
						  <form action="thank-you-whitepapers.php" method="GET">                           
						  <ul class="row">
                                <li class="col-md-6">
...
<iframe src="//searchmarketingsolved.com/Forms/gfembed/?f=7" width="100%" height="500" frameBorder="0" class="gfiframe"></iframe>
