...
<head>
    <meta charset="utf-8">
    <title>Partner Portal | Register</title>
    <!--    <base href="/">-->
    <meta name="viewport" content="width=device-width, initial-scale=1 shrink-to-fit=no">

    <head>
        <link rel="icon" type="image/png" href="partners-portal/favicon.png">
        <link rel="stylesheet" type="text/css" href="partners-portal/css/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="partners-portal/fontawesome/css/all.css" />
        <link rel="stylesheet" type="text/css" href="partners-portal/inteltelinputs/build/css/intlTelInput.min.css" />
        <link rel="stylesheet" type="text/css" href="partners-portal/css/styles.css" />
...
<body>
    ...
    <p style="float:right;padding:4px"><a href="https://pidatacenters.com/" target="_blank"><img src="partners-portal/logo3.png"></a></p><br>
    <div id="loader">
    ...
    <div class="VertiMidwerty">
        ...
        <div class="container-fluid">
            ...
            <div class="m_logo" id="m_logo">
                <img src="partners-portal/PiPartnerProgramlogo.svg">
            </div>
            <div class="m_w_logo" id="m_w_logo">
                <img src="partners-portal/main-logo.png"><br>
                <button style=" margin: 10px 95px;color: white;background-color:#28a745;border: none;padding: 6px 10px;border-radius: 4px;"><a href="partners-login.php" style="color: #fff;text-decoration: none;">Login</a> </button>
            </div>
            <div class="m_b_logo" id="m_b_logo">
                <img src="partners-portal/PiPartnerProgramlogo.svg" style="margin-top:28px !important;">
            </div>
            <div class="mob_white_fav">
                <img src="partners-portal/PiPartnerProgram-Logo-whitelogo-02.png">
            </div>
