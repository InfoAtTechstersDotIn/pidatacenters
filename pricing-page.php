...
<head>
    <title>Top Cloud Service Provider- Harbour1 | Pricing For The Fastest Cloud Servers</title>
    <base href="/pi-cloud/pricing/" />
    <meta charset="UTF-8">
    <meta http-equiv="cache-control" content="no-cache" />
    <meta http-equiv="Pragma" content="no-cache" />
    <meta http-equiv="Expires" content="-1" />
    <meta name="description" content="The top cloud service provider and a one stop shop with an array of products and services to meet enterprise business needs, delivering higher efficiency and optimised TCO.">
    ...
    <script type='text/javascript' src='scripts/controllers/cloudVirtualDedicatedServers.js?vneew123?v4mtkki'></script>
    <script type='text/javascript' src='scripts/controllers/enterpriseDedicatedServersCtrl.js?vneew123?vwye'></script>
    <script type='text/javascript' src='scripts/controllers/cloudStorageCtrl.js?vneew123?V4r'></script>
...
<body ng-app="PiStore">
 ...
 -->
    ...
    font-size: 45px;font-weight:800;">Private Cloud</h1><br>
        <a href="https://pidatacenters.com/pi-cloud/pricing" target="_self" data-ui-sref-opts="{reload: true}" class="cloud-servers-css" style="margin-right: 30px;"> CLOUD SERVERS</a>

        <a href="https://pidatacenters.com/pi-cloud/pricing/#/cloudStorage/" data-ui-sref-opts="{reload: true}" class="cloud-storage-css "> CLOUD STORAGE</a>
    ...
    <script type='text/javascript' src='https://pricing.pidatacenters.com/pidata/p/js/SmoothScroll-1.2.1.js?ver=4.4.2'></script>
