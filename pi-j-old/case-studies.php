							...
							<li class="col-md-4">
							 ...
							 <li class="col-md-4">
                                ...
                                <figure>
									...
									<a href="banking-dc-dr-infrastructure-harbour1-case-study.php"  class="download">Download case study</a> 
                                 </div>
                             </li>
							  ...
							  <li class="col-md-4">
                                ...
                                <figure>
                                    ...
                                    <h4> Cloud  Migration Public Cloud to Harbour1®</h4>
                                    <!--<p><?php //print($blog_desc);?></p>-->
                                    <!--<a href="#modal-1" class="download">Download case study</a>-->
									<!--<a href="case-study-download.php" download class="download">Download case study</a>-->
 									
									<a href="cloud-migration-public-cloud-to-privatecloud-harbour1-case-study.php"  class="download">Download case study</a> 
                                 </div>
                             </li>
							 <li class="col-md-4">
                                <div class="case-content">
