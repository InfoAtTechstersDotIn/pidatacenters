...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/ipx_mbanner.png">
			      <img  src="images/banners/ipx_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            		    <span>
			            			<img src="images/product-images/i1_img.png" alt="workspace">			       
     			                            </span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/i2_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/directconnect_img.png" alt="workspace">				            			
							</span>
			            		</div>
			            	</li>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            			<img src="images/product-images/i5_img.png" alt="workspace">	            		
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/ip2_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
