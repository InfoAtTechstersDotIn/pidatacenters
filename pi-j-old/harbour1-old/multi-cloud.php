...
.hb-productSec {max-width:100% !important;}
...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/Web-banner-Ai.png">
			      <img  src="images/banners/Web-banner-Ai.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
...
<p>The industry today recognizes the business and compliance significance of data localization and data sovereignty within the ambit of the law of land of India. We ensure that our customers can trust us with the safekeeping of their data and being compliant. The numerous used cases of enterprises trusting and partnering with us in infusing their business goals and staying ahead of the curve are testimonials in themselves. We take pride in our relentless industry research and technology assimilations, which have translated into our platform to mirror innovation and thought re-engineering. Our self-owned, multi-local TIER IV Software-Defined Data Centers (SDDC) across India ensure that we can offer high-quality services to our customers while keeping their data safe.</p>
			            	...
			            	<ul class="list-inline hb-featuresList multi-cld-key">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/combination25.png" alt="scale">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/diverse25.png" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/cross25.png" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
                                ...
                                <li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/self25.png" alt="scale">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/cost25.png" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
                                        ...
                                        <p style="text-align:center;">At Harbour 1®, we understand the importance of cost optimization and competitive pricing. We work closely with our customers to ensure that they are getting the best value for their investment without sacrificing the quality of our services.</p>
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/optimal25.png" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
			...
			<div class="hb-childProducts" id="Managed">
				...
				<div id="outer" class="skltbs-theme-light" data-skeletabs='{ "startIndex": 3 }'>
                 ...
                 <a href="https://harbour1.in/multi-cloud#cloudinfo"> <img src="images/product-images/AWS28.png" alt="certfication" style="max-width:100%;margin-top: 70px;"></a>
                
          </div>
		     <div class="item" style="">
                
                    <a href="https://harbour1.in/multi-cloud#cloudinfo"><img src="images/product-images/Managed-multi-cloud-system2856.png" alt="certfication" style="max-width:100%;margin-top: 70px;"></a>
                
          </div>	
		  <div class="item" style="">
                  <a href="https://harbour1.in/multi-cloud#cloudinfo"> 
                  <img src="images/product-images/Google28.png" alt="certfication" style="max-width:100%;margin-top:70px;">
               </a>
          </div> 
	  
		  <div class="item" style="">
                 <a href="https://harbour1.in/multi-cloud#cloudinfo"> 
                  <img src="images/product-images/Oracle28.png" alt="certfication" style="max-width:100%;margin-top:70px;">
              </a>
          </div>
       
		   <div class="item" style="">
                 <a href="https://harbour1.in/multi-cloud#cloudinfo"> 
                  <img src="images/product-images/Azure28.png" alt="certfication" style="max-width:100%;margin-top:70px;">
                </a>
          </div>
			          ...
			          <ul class="hb-productSec list-inline">
			            		<div class="hb-leftCont hb_ppCont">
			            			<p>The Harbour 1® Multi-Cloud Ecosystem simplifies the management of cloud environments by providing a centralized view of your workloads across multiple clouds. This platform allows you to monitor performance and optimize your environment for cost control.</p>
                                    
                                    <p>By streamlining cloud management and reducing complexity, Harbour 1® enhances operational efficiency, freeing up valuable resources for innovation and growth. With a unified view of your cloud environments, you can focus on achieving your business objectives without getting bogged down in day-to-day tasks.</p>
                                     <p>Whether you're migrating to the cloud, optimizing your existing cloud infrastructure, or managing multiple clouds, Harbour 1® provides the tools and unified view you need to succeed in today's digital landscape. With Harbour 1®, you can simplify cloud management, improve ROI, and achieve business objectives with ease.</p>
                                    <span>
            ...
            <div>
					<h1 class="text-center" style="padding:100px 0 0;color:#545454;" id="servicemodel">Managed Services Models</h1>
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
...
Provides different tiers of service levels based on the business's needs, ensuring that you pay only for the services you require. 
 ...
 <li>Basic anti-virus and anti-malware support</li>
							...
							<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/essesntials28.png" alt="tickmark" class="essent">
			            			</span>
			            		</div>
			            	</li>
			            </ul>
						 <ul class="hb-productSec list-inline" style="margin-top:30px">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/Advanced28.png" alt="tickmark" style="width:auto;">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
...
<ul style=" list-style-type: circle;list-style-position:outside;font-size: 15px;
	...
	<li>Advanced operational intelligence and custom dashboard on usage, performance, governance, and cost</li>
							...
							<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/Premium28.png" alt="tickmark" class="prem" style="">
			            			</span>
			            		</div>
			            	</li>
			            </ul>
...
Allows businesses to pay only for what they use, making it a cost-effective model.
			            			...
			            			<span>
			            				<img src="images/product-images/Elastic-Model28.png" alt="advanced">
			            			</span>
...
Allows businesses to select specific services they require, providing flexibility in the services chosen.
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-128.png" alt="A-La-Carte-Model-1" style="max-width:240px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-228.png" alt="A-La-Carte-Model-2" style="max-width:240px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-328.png" alt="A-La-Carte-Model-3" style="max-width:240px">
			            			</div>
			            		</li>
                                <li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-428.png" alt="A-La-Carte-Model-4" style="max-width:240px">
			            			</div>
			            		</li>
                                        <li class=" emty-blk"></li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-528.png" alt="A-La-Carte-Model-5" style="max-width:240px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-628.png" alt="A-La-Carte-Model-6" style="max-width:240px">
			            			</div>
			            		</li>
                                        <li>
			            			<div class="hb-featureBox">
			            				<img src="images/product-images/A-La-Carte-Model-728.png" alt="A-La-Carte-Model-7" style="max-width:240px">
			            			</div>
			            		</li>
                                         <li class="emty-blk"></li>
			            	</ul>
               ...
               <!--<ul class="hb-productSec list-inline appoinment">
				...
				<br><br>
				 ...
				 <ul class="hb-productSec list-inline">
			            		...
			            		<li>
			            			<div class="hb-featureBox" style="text-align:center">
			            				<img src="images/product-images/Oracle288.png" alt="A-La-Carte-Model-2" style="width:150px">
			            			</div>
			            		</li>
			            		<li>
			            			<div class="hb-featureBox" style="text-align:center">
                                ...
                                <li>
			            			<div class="hb-featureBox" style="text-align:center">
			            				<img src="images/product-images/azure28.png" alt="A-La-Carte-Model-4" style="width:100px">
			            			</div>
			            		</li>
