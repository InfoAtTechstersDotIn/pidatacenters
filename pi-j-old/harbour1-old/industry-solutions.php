            ...
            <div class="hb-bannerCont">
                  <div class="hb-bannerImgCont">
                        <div class="hb-bannerImg">
                              <picture>
                               <source media="(max-width: 767px)" srcset="images/banners/solutions_mbanner.png">
                                    <img  src="images/banners/solutions_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
                              </picture>
                        </div>
               ...
               <div  class="ex-dept-Right" id="test">
                  <ul class="list-inline ">
                     <li class="dept-list-group eg-heiAuto">
                        <div class="dept-list">
                           <div class="grid_view">
                              <p class="plus_ico"><img src="images/BFSI.svg" alt="TopPicks"/></p>
                              <h2>BFSI </h2>
                     ...
                     <li class="dept-list-group eg-heiAuto" >
                        <div class="dept-list">
                           <div class="grid_view">
                              <p class="plus_ico"><img src="images/E-Commerce.svg" alt="Compute"/></p>
                              <h2>e-Commerce </h2>
                           </div>
                           <div class="full-cont hwi">
                              <div class="dep-moreInfp">
                      ...
                      <li class="dept-list-group eg-heiAuto">
                        <div class="dept-list">
                           <div class="grid_view">
                              <p class="plus_ico"><img src="images/IT_IES.svg" alt="Network"/></p>
                              <h2>IT / ITES  </h2>
                           </div>
                           <div class="full-cont hwi">
                              <div class="dep-moreInfp">
                      ...
                      <li class="dept-list-group eg-heiAuto">
                        <div class="dept-list">
                           <div class="grid_view">
                              <p class="plus_ico"><img src="images/Manufacturing.svg" alt="Storage"/></p>
                              <h2>Manufacturing  </h2>
                           </div>
                           <div class="full-cont hwi">
                              <div class="dep-moreInfp">
                      ...
                      <li class="dept-list-group eg-heiAuto">
                        <div class="dept-list">
                           <div class="grid_view">
                              <p class="plus_ico"><img src="images/Education.svg" alt="Security"/></p>
                              <h2> Education </h2>
                           </div>
                           <div class="full-cont hwi">
                              <div class="dep-moreInfp">
                       ...
                       <li class="dept-list-group eg-heiAuto">
                        <div class="dept-list">
                           <div class="grid_view">
                              <p class="plus_ico"><img src="images/Healthcare.svg" alt="SAP"/></p>
                              <h2>Healthcare</h2>
                           </div>
                           <div class="full-cont hwi">
                              <div class="dep-moreInfp">
