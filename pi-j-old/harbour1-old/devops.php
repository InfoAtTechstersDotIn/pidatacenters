...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/devops_mbanner.png">
			      <img  src="images/banners/devops_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
	...
	<ul class="list-inline sfdfd_sdajsd">
		<li class="hb-dibsdd">
			<div class="sdhsd_ssdud">
				<div class="jdh_ddksd">
				<p>
					<img src="images/product-page-icons/devops/ci.svg" alt="cicd">
				</p>
			</div>
		...
		<li class="hb-dibsdd">
			<div class="sdhsd_ssdud">
				<div class="jdh_ddksd">
				<p>
					<img src="images/product-page-icons/devops/cd.svg" alt="cicd">
				</p>
			</div>
			<div class="djdf_sdusd">
		...
		<li class="hb-dibsdd">
			<div class="sdhsd_ssdud">
				<div class="jdh_ddksd">
				<p>
						<img src="images/product-page-icons/devops/micro.svg" alt="cicd">
				</p>
			</div>
			<div class="djdf_sdusd">
				<h3>Microservices</h3>
		...
		<li class="hb-dibsdd">
			<div class="sdhsd_ssdud">
				<div class="jdh_ddksd">
				<p>
					<img src="images/product-page-icons/devops/iac.svg" alt="cicd">
				</p>
			</div>
			<div class="djdf_sdusd">
		...
		<li class="hb-dibsdd">
			<div class="sdhsd_ssdud">
				<div class="jdh_ddksd">
				<p>
					<img src="images/product-page-icons/devops/mon.svg" alt="cicd">
				</p>
			</div>
			<div class="djdf_sdusd">
		...
		<li class="hb-dibsdd">
			<div class="sdhsd_ssdud">
				<div class="jdh_ddksd">
				<p>
					<img src="images/product-page-icons/devops/cola.svg" alt="cicd">
				</p>
			</div>
			<div class="djdf_sdusd">
