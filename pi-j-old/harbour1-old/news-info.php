			...
			<div class="hb-newsContSection">
			  <div class="hb-newsDate">
					...
					<div class="hb-newsContDes hb-newsInf">
						...
						<h4>
							<img src="https://harbour1.in/dashboard/public/imgs/<?php echo $post["full_img"]; ?>" alt="news">
						</h4>
				...
				<div class="hb-newsThumb hb-relatedArticals">
					...
					<?php  
						...
						<li class="hb-reLists">
								<div class="hb-arThub" >
									<p>
										<img src="https://harbour1.in/dashboard/public/imgs/<?php echo $relatedNews["thumb"]; ?>" alt="image">
									</p>
								</div>
								<div class="hb-ContI">
