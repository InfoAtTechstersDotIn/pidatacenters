        ...
        <div class="hb-bannerImg">
            <picture>
                <source media="(max-width: 767px)"
                        srcset="./<?= $config['subFolderName'] ?>/images/banners/hardour1-banner-new11.png">
                <img src="./<?= $config['subFolderName'] ?>/images/banners/hardour1-banner-new11.png"
