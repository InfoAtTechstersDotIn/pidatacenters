...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/euc_mbanner.png">
			      <img  src="images/banners/euc_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
			        ...
			        <div class="skltbs-panel-group">
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/cm.svg" alt="onesize">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/e2ev.svg" alt="low">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/ce.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
			            	...
			            	<ul class="list-inline hb-idealList">
			            		<li>
			            			<div class="hb-idealFet">
			            				<span>
			            					<img src="images/Tick.svg"  alt="euc">
			            				</span>
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            			<img src="images/product-images/appstreaming_img.png" alt="workspace">
			            			</span>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/simple.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/ux.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/secure.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/remoteaccess_img.png" alt="workspace">	
							</span>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/zt.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/sso.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/euc/sa.svg"  alt="euc">
			            					</p>
			            					<div class="hb-featCont">
