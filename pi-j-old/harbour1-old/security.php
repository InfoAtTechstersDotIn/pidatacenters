...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/cs_mbanner.png">
			      <img  src="images/banners/cs_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
			        ...
			        <div class="skltbs-panel-group">
			          <div class="skltbs-panel current" id="tab-1">
			            <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/ddos_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            </ul>
			          ...
			          <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            			<img src="images/product-images/av_img.png" alt="workspace">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/waf_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			           ...
			           <div class="skltbs-panel" id="tab-3">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/epp_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/iam_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			           ...
			           <div class="skltbs-panel" id="tab-4">
			            	...
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/soc_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/vapt_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/vault_img.png" alt="workspace">
