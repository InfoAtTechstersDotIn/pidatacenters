		...
		<div class="hb-bannerCont">
			<div class="hb-bannerImgCont">
				<div class="hb-bannerImg">
					<picture>
			        	 <source media="(max-width: 767px)" srcset="images/banners/bc_mbanner.png">
			      	   	<img  src="images/banners/bc_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      				</picture>
				</div>
			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/dr_img.png" alt="workspace">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/bc/cd.svg" alt="onesize">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/bc/rf.svg" alt="low">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/bc/drd.svg"  alt="workspace">
			            					</p>
			            					<div class="hb-featCont">
			            						<h6>DR Drills </h6>
			            	...
			            	<ul class="list-inline hb-idealList">
			            		<li>
			            			<div class="hb-idealFet">
			            				<span>
			            					<img src="images/Tick.svg"  alt="workspace">
			            				</span>
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/backup_img.png" alt="workspace">			            			</span>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/bc/eou.svg"  alt="workspace">
			            					</p>
			            					<div class="hb-featCont">
			            						<h6>Ease of use</h6>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/bc/hcb.svg"  alt="workspace">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/bc/fdb.svg"  alt="workspace">
			            					</p>
			            					<div class="hb-featCont">
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/onesize.svg"  alt="workspace">
			            					</p>
			            					<div class="hb-featCont">
			            						<h6>HA clustering</h6>
