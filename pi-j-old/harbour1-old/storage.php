...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<picture>
			     <source media="(max-width: 768px)" srcset="images/banners/storage_mbanner.png">
			      <img  src="images/banners/storage_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
		</div>		
	</div>
</div>
			        ...
			        <div class="skltbs-panel-group">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/block_img.png" alt="tickmark">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/hp.svg" alt="scale">
			            					</p>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/dr.svg" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/snap.svg" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
			          ...
			          <ul class="hb-productSec list-inline">
			            	...
			            	<li>
			            		<div class="hb-rightCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/object_img.png" alt="workspace">
			            			</span>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/dt.svg" alt="scale-3">
			            					</p>
			            					<div class="hb-featCont">
			            						<h6>Data Transfer</h6>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/sc.svg" alt="economics"> 
			            					</p>
			            					<div class="hb-featCont">
			            						<h6>Scalability</h6>
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/md.svg" alt="Self">
			            					</p>
			            					<div class="hb-featCont">
			            ...
			            <ul class="hb-productSec list-inline">
			            	<li>
			            		<div class="hb-leftCont hb_ppCont">
			            			<span>
			            				<img src="images/product-images/file_img.png" alt="tickmark">
			            			</span>
			            		</div>
			            	</li>
			            	<li>
			            	...
			            	<ul class="list-inline hb-featuresList">
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/os.svg" alt="scale">
			            					</p>
			            					<div class="hb-featCont">
			            		...
			            		<li>
			            			<div class="hb-featureBox">
			            				<div class="hb-featTopHeader">
			            					<p class="hb-featLogo">
			            						<img src="images/product-page-icons/st/mas.svg" alt="economics">
			            					</p>
			            					<div class="hb-featCont">
