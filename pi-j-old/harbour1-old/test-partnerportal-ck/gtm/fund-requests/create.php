...
<!--    **************************  -->  
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <form id="frm-gtm-fund-req" class="gtm-forms" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fproj-cost" class="required">Total Estimate Project Cost (In INR Lakhs) </label>
                  <input type="number" class="form-control" id="fproj-cost" name="gtm_fundreq_proj_cost" min="0" step="any" required>
...
<!-- 
                <div class="form-group col-xs-12 col-sm-12 col-md-4">
                  <label for="budget-plan">Upload Budget Plan Document</label>
                  <input type="file" name="budget_plan_doc" id="budget-plan" class="form-control" />
                </div> -->

                <div class="form-group col-md-4 col-sm-12">
                  <label for="fobjective" class="required">Objective</label>
                  <textarea class="form-control" id="fobjective" name="gtm_fundreq_objective" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="ftarget-mrket" class="required">Target Market</label>
                  <textarea class="form-control" id="ftarget-market" name="gtm_fundreq_market" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fpart-ownership" class="required">Partner's Ownership</label>
                  <textarea class="form-control" id="fpart-ownership" name="gtm_fundreq_part_ownership" required></textarea>
                </div>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <textarea class="form-control" id="fexisting-sponsors" name="gtm_fundreq_sponsers" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fspon-deliverables" class="required">Existing Sponsor Deliverables</label>
                  <textarea class="form-control" id="fspon-deliverables" name="gtm_fundreq_spon_deliverables" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fpi-deliverables" class="required">Deliverables For Pi</label>
                  <textarea class="form-control" id="fpi-deliverables" name="gmt_fundreq_pi_deliverables" required></textarea>
                </div>
              </div>
              <div class="row">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <input type="number" class="form-control" id="ffund-requested" name="gtm_fundreq_fund_requested" min="0" step="any" >
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fcomments" class="required">Additional Comments</label>
                  <textarea class="form-control" id="fcomments" name="gtm_fundreq_comments" required></textarea>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3 col-sm-12">
                  ...
                  <input type="number" class="form-control" id="fExecMob" name="gtm_fundreq_exe_mob" required>
                </div>
                <div class="form-group col-md-3 col-sm-12">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <input type="number" class="form-control" id="fMarkMob" name="gtm_fundreq_mark_mob"  required>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="form-group col-md-6 col-sm-12">
                  ...
                  <textarea class="form-control" id="fparam" name="gtm_fundreq_success_params" required></textarea>
                </div>
                <div class="form-group col-md-6 col-sm-12">
                  <label for="fmetric" class="required">Enter Success Metrics</label>
                  <textarea class="form-control" id="fmetric" name="gtm_fundreq_success_metrics" required></textarea>
                </div>
              </div>
