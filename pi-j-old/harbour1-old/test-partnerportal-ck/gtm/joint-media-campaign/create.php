            ...
            <form id="frm-gtm-media-campaign-req" class="gtm-forms" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <textarea class="form-control" id="fobjective" name="gtm_mcampaign_objective" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="ftarget-mrket" class="required">Target Market</label>
                  <textarea class="form-control" id="ftarget-market" name="gtm_mcampaign_market" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fpart-ownership" class="required">Partner's Ownership</label>
                  <textarea class="form-control" id="fpart-ownership" name="gtm_mcampaign_part_ownership" required></textarea>
                </div>
              ...
              <div class="row">
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <textarea class="form-control" id="fexisting-sponsors" name="gtm_mcampaign_sponsors" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fspon-deliverables" class="required">Existing Sponsor Deliverables</label>
                  <textarea class="form-control" id="fspon-deliverables" name="gtm_mcampaign_spon_deliverables" required></textarea>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="fpi-deliverables" class="required">Deliverables For Pi</label>
                  <textarea class="form-control" id="fpi-deliverables" name="gmt_mcampaign_pi_deliverables" required></textarea>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-4 col-sm-12">
                  <label for="ffund-requested">GTM Fund Requested to Pi (In INR Lakhs) </label>
                  <input type="number" class="form-control" id="ffund-requested" name="gtm_mcampaign_fund_requested" min="0" step="any">
                </div>

                <div class="form-group col-md-4 col-sm-12">
                  <label for="fcomments" class="required">Additional Comments</label>
                  <textarea class="form-control" id="fcomments" name="gtm_mcampaign_comments" required></textarea>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6 col-sm-12">
                  ...
                  <textarea class="form-control" id="fmed-house-online" name="gtm_mcampaign_media_online" required></textarea>
                </div>
                <div class="form-group col-md-6 col-sm-12">
