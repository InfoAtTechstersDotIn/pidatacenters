                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <label class="checkbox-inline col-md-4">
                                                <input type="radio" value="Recurring Commission"
                                            ...
                                            <label class="checkbox-inline col-md-4">
                                                <input type="radio" value="One-Time Referral Bonus" name="partnership_model"
                                          ...
                                          The transfer price shall be discussed and agreed on case to case basis between Pi and the Partner."></b>
                                            ...
                                            <label class="checkbox-inline col-md-3">
                                                <input type="radio" value="Transfer Price" name="partnership_model"
