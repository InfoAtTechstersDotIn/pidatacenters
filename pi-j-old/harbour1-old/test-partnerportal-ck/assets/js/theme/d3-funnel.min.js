    ...
    var t = {
        745: function (t, e, n) {
          ...
          function _(t, e, n, r, i, o) {
            for (var a, s = 0, u = e.length, l = o.length; s < l; ++s)
              (a = e[s])
          ...
          function T(t, e) {
            return (
              ...
              D(t).getComputedStyle(t, null).getPropertyValue(e)
            );
          }
          function z(t) {
            return function () {
          ...
          function W(t, e) {
            return function () {
              (e.apply(this, arguments) ? Y : Q)(this, t);
            };
          }
          function U() {
            this.textContent = "";
          ...
          function it(t) {
            return function () {
              var e = this.ownerDocument,
                n = this.namespaceURI;
              return n === E && e.documentElement.namespaceURI === E
                ? e.createElement(t)
          ...
          mt.prototype = bt.prototype = {
            ...
            filter: function (t) {
              ...
              for (
                ...
                for (
                  var o, a = e[i], s = a.length, u = (r[i] = []), l = 0;
                  l < s;
                  ++l
                )
                  (o = a[l]) && t.call(o, o.__data__, l, a) && u.push(o);
              return new mt(r, this._parents);
            },
            data: function (t, e) {
              ...
              for (
                ...
                var h = r[c],
                  ...
                  m = (u[c] = new Array(p));
                n(h, f, v, y, m, d, e);
                for (var b, A, E = 0, P = 0; E < g; ++E)
                  if ((b = v[E])) {
                    for (E >= P && (P = E + 1); !(A = y[P]) && ++P < g; );
                    b._next = A || null;
                  }
              }
              return ((a = new mt(a, r))._enter = s), (a._exit = u), a;
            },
            enter: function () {
              return new mt(this._enter || this._groups.map(m), this._parents);
            },
            exit: function () {
              return new mt(this._exit || this._groups.map(m), this._parents);
            },
            join: function (t, e, n) {
              var r = this.enter(),
                i = this,
            ...
            merge: function (t) {
              if (!(t instanceof mt)) throw new Error("invalid merge");
              for (
                var e = this._groups,
                  n = t._groups,
                  r = e.length,
            ...
            style: function (t, e, n) {
              return arguments.length > 1
                ? this.each(
                    (null == e ? B : "function" == typeof e ? I : H)(
                      t,
                      e,
                      null == n ? "" : n
                    )
            ...
            property: function (t, e) {
              return arguments.length > 1
                ? this.each(
                    (null == e ? z : "function" == typeof e ? R : F)(t, e)
                  )
                : this.node()[t];
            },
            classed: function (t, e) {
              ...
              return this.each(("function" == typeof e ? W : e ? $ : G)(n, e));
            },
            text: function (t) {
              return arguments.length
                ? this.each(null == t ? U : ("function" == typeof t ? J : K)(t))
                : this.node().textContent;
            },
            html: function (t) {
              return arguments.length
                ? this.each(
                    null == t ? Z : ("function" == typeof t ? et : tt)(t)
                  )
                : this.node().innerHTML;
            },
            raise: function () {
            ...
            insert: function (t, e) {
              var n = "function" == typeof t ? t : at(t),
                r = null == e ? st : "function" == typeof e ? e : u(e);
              return this.select(function () {
            ...
            dispatch: function (t, e) {
              return this.each(("function" == typeof e ? vt : gt)(t, e));
            },
          ...
          At.prototype = xt.prototype = {
            ...
            on: function (t, e) {
              ...
              if (!(arguments.length < 2)) {
                ...
                for (; ++o < a; )
                  if ((n = (t = i[o]).type)) r[n] = St(r[n], t.name, e);
                  else if (null == e)
                    for (n in r) r[n] = St(r[n], t.name, null);
                return this;
              }
              for (; ++o < a; )
                if ((n = (t = i[o]).type) && (n = Pt(r[n], t.name))) return n;
            },
            copy: function () {
              var t = {},
                e = this._;
          ...
          function qt() {
            (Bt = (Dt = It.now()) + Ht), (Nt = Lt = 0);
            try {
              !(function () {
                zt(), ++Nt;
                for (var t, e = Mt; e; )
                  (t = Bt - e._time) >= 0 && e._call.call(null, t),
                    (e = e._next);
                --Nt;
              })();
            } finally {
          ...
          function Yt(t) {
            Nt ||
              ...
              t - Bt > 24
                ? (t < 1 / 0 && (Lt = setTimeout(qt, t - It.now() - Ht)),
                  jt && (jt = clearInterval(jt)))
                : (jt || ((Dt = It.now()), (jt = setInterval(Vt, 1e3))),
                  (Nt = 1),
                  Tt(qt)));
          }
          function Qt(t, e, n) {
          ...
          Rt.prototype = Xt.prototype = {
            constructor: Rt,
            restart: function (t, e, n) {
              if ("function" != typeof t)
                throw new TypeError("callback is not a function");
              (n = (null == n ? zt() : +n) + (null == e ? 0 : +e)),
                this._next ||
                  Ot === this ||
                  (Ot ? (Ot._next = this) : (Mt = this), (Ot = this)),
                (this._call = t),
                (this._time = n),
                Yt();
            },
          ...
          var $t = Ct("start", "end", "cancel", "interrupt"),
            Gt = [];
            ...
            !(function (t, e, n) {
              ...
              function o(u) {
                ...
                if (
                  ...
                  for (
                    n.state = 3,
                      r = new Array((h = n.tween.length)),
                      l = 0,
                      c = -1;
                    l < h;
                    ++l
                  )
                    (f = n.tween[l].value.call(
                      t,
                      t.__data__,
                      n.index,
                      n.group
          ...
          var oe = ie(
              function (t) {
                ...
                return e.isIdentity ? ne : re(e.a, e.b, e.c, e.d, e.e, e.f);
              },
              "px, ",
              "px)",
              "deg)"
          ...
          function ue(t, e, n) {
            ...
            return function () {
              ...
              if (a !== r) {
                i = (r = a).slice();
                for (
                  var s = { name: e, value: n }, u = 0, l = i.length;
                  u < l;
                  ++u
                )
                  if (i[u].name === e) {
          ...
          var pe = 0.7,
            ...
            ye = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
            me = /^#([0-9a-f]{3,8})$/,
            be = new RegExp("^rgb\\(" + [ge, ge, ge] + "\\)$"),
            we = new RegExp("^rgb\\(" + [ye, ye, ye] + "\\)$"),
            _e = new RegExp("^rgba\\(" + [ge, ge, ge, ve] + "\\)$"),
            ke = new RegExp("^rgba\\(" + [ye, ye, ye, ve] + "\\)$"),
            xe = new RegExp("^hsl\\(" + [ve, ye, ye] + "\\)$"),
            Ae = new RegExp("^hsla\\(" + [ve, ye, ye, ve] + "\\)$"),
            Ee = {
              aliceblue: 15792383,
          ...
          function Me(t) {
            ...
            return (
              ...
              (e = me.exec(t))
                ...
                : (e = xe.exec(t))
                ? Ie(e[1], e[2] / 100, e[3] / 100, 1)
                : (e = Ae.exec(t))
                ? Ie(e[1], e[2] / 100, e[3] / 100, e[4])
                : Ee.hasOwnProperty(t)
                ? Oe(Ee[t])
                : "transparent" === t
          ...
          function Oe(t) {
            return new je((t >> 16) & 255, (t >> 8) & 255, 255 & t, 1);
          }
          function Ce(t, e, n, r) {
            return r <= 0 && (t = e = n = NaN), new je(t, e, n, r);
          }
          function Ne(t) {
            return (
              t instanceof fe || (t = Me(t)),
              t ? new je((t = t.rgb()).r, t.g, t.b, t.opacity) : new je()
            );
          }
          function Le(t, e, n, r) {
          ...
          function Te(t) {
            ...
            if ((t instanceof fe || (t = Me(t)), !t)) return new ze();
          ...
          ce(fe, Me, {
            ...
            ce(
              ...
              he(fe, {
                brighter: function (t) {
                  return (
                    (t = null == t ? de : Math.pow(de, t)),
                    new je(this.r * t, this.g * t, this.b * t, this.opacity)
                  );
                },
                darker: function (t) {
                  return (
            ...
            Ye(function (t) {
              ...
              return function (n) {
                var r = Math.floor(((n %= 1) < 0 ? ++n : n) * e),
                  ...
                  a = t[(r + 1) % e],
                  s = t[(r + 2) % e];
                return Re((n - r / e) * e, i, o, a, s);
              };
            });
          var Qe = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
            $e = new RegExp(Qe.source, "g");
          function Ge(t, e) {
            var n,
              r,
              i,
              o = (Qe.lastIndex = $e.lastIndex = 0),
              a = -1,
              s = [],
              u = [];
            for (t += "", e += ""; (n = Qe.exec(t)) && (r = $e.exec(e)); )
              (i = r.index) > o &&
                ...
                (n = n[0]) === (r = r[0])
                  ? s[a]
                    ? (s[a] += r)
                    : (s[++a] = r)
                  : ((s[++a] = null), u.push({ i: a, x: Zt(n, r) })),
                (o = $e.lastIndex);
            return (
              o < e.length &&
                ((i = e.slice(o)), s[a] ? (s[a] += i) : (s[++a] = i)),
              s.length < 2
                ? u[0]
                  ? (function (t) {
                      return function (e) {
          ...
          function tn(t, e, n) {
            ...
            return function () {
              var a,
                ...
                u = n(this);
              if (null != u)
                return (a = this.getAttribute(t)) === (s = u + "")
                  ? null
                  : a === r && s === i
                  ? o
                  : ((i = s), (o = e((r = a), u)));
          ...
          var pn = wt.prototype.constructor;
          function dn(t) {
            return function () {
              this.style.removeProperty(t);
            };
          ...
          wn.prototype = function (t) {
            ...
            attr: function (t, e) {
              ...
              return this.attrTween(
                t,
                "function" == typeof e
                  ? (n.local ? en : tn)(n, r, le(this, "attr." + t, e))
                  : null == e
                  ? (n.local ? Ke : Ue)(n)
                  : (n.local ? Ze : Je)(n, r, e)
              );
            ...
            attrTween: function (t, e) {
              ...
              if ("function" != typeof e) throw new Error();
              var r = S(t);
              return this.tween(n, (r.local ? on : an)(r, e));
            },
            style: function (t, e, n) {
              var r = "transform" == (t += "") ? oe : We;
              return null == e
                ? this.styleTween(
                    t,
                    (function (t, e) {
                ...
                ? this.styleTween(
                    ...
                    (function (t, e) {
                      ...
                      return function () {
                        var u = Kt(this, t),
                          l = u.on,
                          c = null == u.value[a] ? o || (o = dn(e)) : void 0;
                        (l === n && i === c) ||
                          (r = (n = l).copy()).on(s, (i = c)),
                          (u.on = r);
                      };
            ...
            tween: function (t, e) {
              ...
              if (((t += ""), arguments.length < 2)) {
                for (
                  var r, i = Jt(this.node(), n).tween, o = 0, a = i.length;
                  o < a;
                  ++o
                )
              ...
              return this.each((null == e ? se : ue)(n, t, e));
            },
            delay: function (t) {
              var e = this._id;
              return arguments.length
                ? this.each(("function" == typeof t ? sn : un)(e, t))
                : Jt(this.node(), e).delay;
            },
            duration: function (t) {
              var e = this._id;
              return arguments.length
                ? this.each(("function" == typeof t ? ln : cn)(e, t))
            ...
            return (
              ...
              (n = [
                ...
                },
                {
                  key: "getBlockRawFill",
                  value: function (t, e) {
                    return this.hexExpression.test(t)
                      ? t
                ...
                },
                {
                  ...
                  value: function (t, e, n) {
                    return "solid" === n
                      ? t
                      : "url(#".concat(this.getGradientId(e), ")");
                  },
                },
                {
                  key: "getGradientId",
                  value: function (t) {
                    return "".concat(this.instanceId, "-gradient-").concat(t);
                  },
                },
                {
                  key: "getLabelColor",
                  ...
                  value: function (t, e) {
                    var n = this.hexToRgb(t),
                      ...
                      u =
                        ...
                        256 * (Math.round((a - i) * s) + i) +
                        (Math.round((a - o) * s) + o);
                    return "#".concat(u.toString(16).slice(1));
                  },
                },
                {
                  key: "hexToRgb",
              ...
              (n = [
                ...
                },
                {
                  ...
                  value: function (t, e, n, r) {
                    var i = n;
                    return (
                      null === n && (i = this.getDefaultFormattedValue(e)),
                      r
                        .split("{l}")
                        .join(t)
                        .split("{v}")
              ...
              (n = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return e
                      ? this.makeBezierPath(n, t.ratio)
                      : this.makeBezierPath(n);
                  },
                },
                {
                    ...
                    var e = t.p00,
                      ...
                      s =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ? arguments[1]
                          : 1,
                      u = this.getQuadraticBezierCurve(e, n, r, s),
                      l = this.getQuadraticBezierCurve(i, o, a, s);
                    return [
                      [u.p0.x, u.p0.y, "M"],
                      [u.p1.x, u.p1.y, "Q"],
                      [u.p2.x, u.p2.y, ""],
              ...
              (n = [
                {
                  ...
                  value: function (t) {
                    return (
                      "object" === Nn(t) && null !== t && !Array.isArray(t)
                    );
                  },
                },
                {
                  ...
                  value: function (e, n) {
                    var r = {};
                    return (
                      Object.keys(e).length > 0 && (r = t.extend({}, e)),
                      Object.keys(n).forEach(function (i) {
                        t.isExtendableObject(n[i])
                          ? t.isExtendableObject(e[i])
                            ? (r[i] = t.extend(e[i], n[i]))
                            : (r[i] = t.extend({}, n[i]))
                          : (r[i] = n[i]);
                      }),
                      r
          ...
          var Xn = (function () {
            function t(e) {
              !(function (t, e) {
                ...
                (this.container = _t(e).node()),
                (this.colorizer = new Pn()),
                (this.formatter = new Mn()),
                (this.navigator = new Cn()),
                (this.id = null),
              ...
              (n = [
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    (this.id = "d3-funnel-".concat(
                      ...
                      this.colorizer.setLabelFill(n.label.fill),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      (Array.isArray(t[0]) && t[0].length < 2) ||
                      (!1 === Array.isArray(t[0]) &&
                        (void 0 === t[0].label || void 0 === t[0].value))
                    )
                      throw new Error(
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = this.getContainerDimensions(),
                      n = this.getDefaultSettings(e),
                      r = jn.extend({}, n);
                    return (
                      ((r = jn.extend(r, t)).chart = Tn(
                        Tn({}, r.chart),
                        this.castDimensions(r, e)
                      )),
                      r
                    );
                  },
                },
                {
                  ...
                  value: function (e) {
                    var n = t.defaults;
                    return (n.chart = Tn(Tn({}, n.chart), e)), n;
                  },
                },
                {
                  ...
                  value: function () {
                    var t = {
                      width: parseFloat(_t(this.container).style("width")),
                      height: parseFloat(_t(this.container).style("height")),
                    };
                    return (
                    ...
                    return (
                      Object.keys(n).forEach(function (e) {
                        var o = r[e],
                          a = n[e];
                        /%$/.test(String(o))
                          ? (i[e] = (parseFloat(o) / 100) * a)
                          : (i[e] = o <= 0 ? t.defaults.chart[e] : o);
                      }),
                      i
                    );
                  },
                ...
                },
                {
                  key: "getTotalCount",
                  value: function (t) {
                    return null !== this.settings.totalCount
                      ? this.settings.totalCount || 0
                      : t.reduce(function (t, e) {
                          return t + jn.getRawBlockCount(e);
                        }, 0);
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    return t.map(function (r, i) {
                      var o = Array.isArray(r) ? jn.convertLegacyBlock(r) : r,
                      ...
                      return {
                        ...
                        tooltip: {
                          enabled: o.enabled,
                          formatted: n.formatter.format(o, n.tooltipFormatter),
                        },
                      };
                    });
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    (this.blockPaths = n[0]),
                      (this.overlayPaths = n[1]),
                      "gradient" === this.settings.fillType &&
                ...
                },
                {
                  ...
                  value: function () {
                    var t = this,
                      e = (this.settings.width - this.settings.bottomWidth) / 2,
                    ...
                    var o = this.dx,
                      a = this.dy,
                      s = 0,
                      u = this.settings.width,
                      l = 0;
                    this.settings.isInverted &&
                      ((s = e), (u = this.settings.width - e));
                    var c = 0,
                      h = 0,
                      f = 0;
                    this.settings.isCurved &&
                      (l = this.settings.curveHeight / 2);
                    ...
                    this.settings.bottomPinch > 0 &&
                      this.blocks.forEach(function (e, n) {
                        var r = p * e.ratio;
                        0 !== t.settings.minHeight &&
                          (r += t.settings.minHeight),
                          t.settings.isCurved &&
                            (r += t.settings.curveHeight / t.blocks.length),
                          t.settings.isInverted
                            ? n < t.settings.bottomPinch && (d -= r)
                            : n >= t.blocks.length - t.settings.bottomPinch &&
                              (d -= r);
                      });
                    var g = d / e;
                    return (
                      this.blocks.forEach(function (e, d) {
                        if (
                          (t.settings.dynamicHeight &&
                            ((a = p * e.ratio),
                            0 !== t.settings.minHeight &&
                              (a += t.settings.minHeight),
                            t.settings.isCurved &&
                              (a -= t.settings.curveHeight / t.blocks.length),
                            (c = (l + a) / g),
                            t.settings.isInverted &&
                              (c = (l + a - t.settings.height) / (-1 * g)),
                            0 === t.settings.bottomWidth &&
                              d === t.blocks.length - 1 &&
                              ((c = t.settings.width / 2),
                              t.settings.isInverted && (c = 0)),
                            t.settings.bottomWidth === t.settings.width &&
                              (c = s),
                            (!Number.isNaN(c) && Number.isFinite(c)) || (c = 0),
                            (o = c - s),
                            t.settings.isInverted && (o = s - c)),
                          t.settings.dynamicSlope && !t.settings.isInverted)
                        ) {
                          var v =
                            (t.blocks[d + 1]
                              ? t.blocks[d + 1].value
                        ...
                        t.settings.bottomPinch > 0 &&
                          (t.settings.isInverted
                            ? (t.settings.dynamicHeight || (o = t.dx),
                              (o = d < t.settings.bottomPinch ? 0 : o))
                            : d >= t.blocks.length - t.settings.bottomPinch &&
                              (o = 0)),
                          (c = s + o),
                          (h = u - o),
                          (f = l + a),
                          (t.blocks[d].height = a),
                          t.settings.isInverted && ((c = s - o), (h = u + o));
                        var y = {
                          centerX: n,
                          prevLeftX: s,
                          prevRightX: u,
                        ...
                        t.settings.isCurved
                          ? ((r = [].concat(Dn(r), [
                              t.navigator.makeCurvedPaths(y),
                            ])),
                            t.settings.addValueOverlay &&
                              (i = [].concat(Dn(i), [
                                t.navigator.makeCurvedPaths(y, !0),
                              ])))
                          : ((r = [].concat(Dn(r), [
                              t.navigator.makeStraightPaths(y),
                            ])),
                            t.settings.addValueOverlay &&
                              (i = [].concat(Dn(i), [
                                t.navigator.makeStraightPaths(y, !0),
                              ]))),
                          (s = c),
                          (u = h),
                          (l = f);
                ...
                },
                {
                  key: "getDx",
                  value: function (t) {
                    return this.settings.bottomPinch > 0
                      ? t / (this.blocks.length - this.settings.bottomPinch)
                ...
                },
                {
                  key: "getDy",
                  value: function () {
                    return this.settings.isCurved
                      ? (this.settings.height - this.settings.curveHeight) /
                          this.blocks.length
                      : this.settings.height / this.blocks.length;
                  },
                },
                {
                  ...
                  value: function (t) {
                    ...
                    this.blocks.forEach(function (t, r) {
                      var i = t.fill.raw,
                        o = e.colorizer.shade(i, -0.2),
                        a = n
                          .append("linearGradient")
                          .attr("id", e.colorizer.getGradientId(r));
                      [
                        [0, o],
                        [40, i],
                        [60, i],
                        ...
                        a.append("stop")
                          .attr("offset", "".concat(t[0], "%"))
                          .attr("style", "stop-color: ".concat(t[1]));
                      });
                    });
                  },
                },
                {
                  key: "drawTopOval",
                  value: function (t, e) {
                    var n = this.settings.width / 2,
                      r = e[0],
                      i = r[1][1] + this.settings.curveHeight / 2,
                      o = this.navigator.plot([
                        ["M", r[0][0], r[0][1]],
                        ["Q", n, i],
                        [" ", r[2][0], r[2][1]],
                        ["M", r[2][0], this.settings.curveHeight / 2],
                        ["Q", n, 0],
                        [" ", r[0][0], this.settings.curveHeight / 2],
                      ]);
                    t.append("path")
                      .attr(
                        "fill",
                  ...
                  value: function (t) {
                    ...
                    if (t !== this.blocks.length) {
                      var n = this.svg.append("g"),
                        i = this.blocks[t],
                        o = this.getBlockPath(n, t);
                      this.attachData(o, i);
                      var a = null,
                        s = i.fill.actual;
                      this.settings.addValueOverlay &&
                        ((a = this.getOverlayPath(n, t)),
                        this.attachData(a, i),
                        o.node().setAttribute("pathType", "background"),
                        a.node().setAttribute("pathType", "foreground"),
                        (s = this.colorizer.shade(i.fill.raw, 0.3))),
                        0 !== this.settings.animation
                          ? o
                              ...
                              .ease(r)
                              .attr("fill", s)
                              .attr("d", this.getPathDefinition(t))
                              .on("end", function () {
                                e.drawBlock(t + 1);
                              })
                          : (o
                            ...
                            this.drawBlock(t + 1)),
                        this.settings.addValueOverlay &&
                          (o.attr("stroke", this.blocks[t].fill.raw),
                          0 !== this.settings.animation
                            ? a
                                .transition()
                                .duration(this.settings.animation)
                                .ease(r)
                                .attr("fill", i.fill.actual)
                                .attr("d", this.getOverlayPathDefinition(t))
                            : a
                                .attr("fill", i.fill.actual)
                                .attr("d", this.getOverlayPathDefinition(t))),
                        this.settings.hoverEffects &&
                          [o, a].forEach(function (t) {
                            t &&
                              t
                                .on("mouseover", e.onMouseOver)
                                .on("mouseout", e.onMouseOut);
                          }),
                          ...
                          [o, a].forEach(function (t) {
                            t &&
                              t
                                ...
                                .on("click", e.settings.onBlockClick);
                          }),
                        this.settings.tooltip.enabled &&
                          [o, a].forEach(function (t) {
                            t &&
                              (t
                                .node()
                                .addEventListener("mouseout", function () {
                                  e.tooltip &&
                                    (e.container.removeChild(e.tooltip),
                                    (e.tooltip = null));
                                }),
                              t
                                .node()
                                .addEventListener("mousemove", function (t) {
                                  e.tooltip ||
                                    ...
                                    e.tooltip.setAttribute(
                                      "class",
                                      "d3-funnel-tooltip"
                                    ),
                                    e.container.appendChild(e.tooltip)),
                                    (e.tooltip.innerText = i.tooltip.formatted);
                                  var n = e.tooltip.offsetWidth,
                                    r = e.tooltip.offsetHeight + 5,
                                    o =
                                      e.container.getBoundingClientRect().y +
                                      window.scrollY,
                                    a =
                                      t.pageY - r < o
                                        ? t.pageY + 5
                                    ...
                                    s = [
                                      ...
                                      "position: absolute",
                                      "left: ".concat(t.pageX - n / 2, "px"),
                                      "top: ".concat(a, "px"),
                                      "border: 1px solid ".concat(i.fill.raw),
                                  ...
                                  e.tooltip.setAttribute("style", s.join(";"));
                                }));
                          }),
                        this.settings.label.enabled &&
                          i.label.enabled &&
                          this.addBlockLabel(n, t);
                    }
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    return (
                      0 !== this.settings.animation &&
                        this.addBeforeTransition(n, e, !1),
                      n
                    );
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    return (
                      0 !== this.settings.animation &&
                        this.addBeforeTransition(n, e, !0),
                      n
                    );
                  },
                },
                {
                  ...
                  value: function (t, e, n) {
                    var r,
                      i,
                      o = n ? this.overlayPaths[e] : this.blockPaths[e];
                    (r = this.settings.isCurved
                      ? this.navigator.plot([
                          ["M", o[0][0], o[0][1]],
                          ["Q", o[1][0], o[1][1]],
                          [" ", o[2][0], o[2][1]],
                      ...
                      (i =
                        "solid" === this.settings.fillType && e > 0
                          ? this.blocks[e - 1].fill.actual
                          : this.blocks[e].fill.actual),
                      t.attr("d", r).attr("fill", i);
                  },
                },
                {
                  key: "attachData",
                  value: function (t, e) {
                    var n = Tn(Tn({}, e), {}, { node: t.node() });
                    t.data([n]);
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = [];
                    return (
                      this.blockPaths[t].forEach(function (t) {
                        e.push([t[2], t[0], t[1]]);
                      }),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = [];
                    return (
                      this.overlayPaths[t].forEach(function (t) {
                        e.push([t[2], t[0], t[1]]);
                      }),
                      this.navigator.plot(e)
                    );
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    var n = this;
                    Dn(t.target.parentElement.childNodes).forEach(function (t) {
                      "path" === t.nodeName.toLowerCase() &&
                        ("foreground" === (t.getAttribute("pathType") || "")
                          ? _t(t).attr(
                              "fill",
                              n.colorizer.shade(e.fill.raw, -0.5)
                            )
                          : _t(t).attr(
                              "fill",
                              n.colorizer.shade(e.fill.raw, -0.2)
                            ));
                    });
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    var n = this;
                    Dn(t.target.parentElement.childNodes).forEach(function (t) {
                      if ("path" === t.nodeName.toLowerCase())
                        if (
                          "background" === (t.getAttribute("pathType") || "")
                        ) {
                          var r = n.colorizer.shade(e.fill.raw, 0.3);
                          _t(t).attr("fill", r);
                        } else _t(t).attr("fill", e.fill.actual);
                    });
                  },
                },
                {
                  key: "addBlockLabel",
                  value: function (t, e) {
                    var n = this.blockPaths[e],
                      r = this.blocks[e].label.formatted,
                      i = this.blocks[e].label.color,
                      o = this.settings.width / 2,
                      a = this.getTextY(n),
                      s = t
                        .append("text")
                        .attr("x", o)
                    ...
                    null !== this.settings.label.fontFamily &&
                      s.attr("font-family", this.settings.label.fontFamily),
                      this.addLabelLines(s, r, o);
                  },
                },
                {
                  key: "addLabelLines",
                  value: function (t, e, n) {
                    ...
                    r.forEach(function (e, r) {
                      var o = 0 === r ? i : 20;
                      t.append("tspan").attr("x", n).attr("dy", o).text(e);
                    });
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = this.settings,
                      ...
                      r = e.curveHeight;
                    return n
                      ? (t[2][1] + t[3][1]) / 2 + (1.5 * r) / this.blocks.length
                      : (t[1][1] + t[2][1]) / 2;
                  },
                },
              ]) && Fn(e.prototype, n),
          ...
          Rn(Xn, "defaults", {
            chart: {
              ...
              horizontal: !1,
              animate: 0,
              curve: { enabled: !1, height: 20, shade: -0.4 },
              totalCount: null,
            },
            block: {
              dynamicHeight: !1,
