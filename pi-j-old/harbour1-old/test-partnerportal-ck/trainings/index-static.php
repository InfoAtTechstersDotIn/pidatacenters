		...
		var calendar =  $('#calendar').fullCalendar({
			...
			events: [
				
				{
					...
					start: new Date(2021, 8, 3, 15, 00),
					allDay: false,
					url: '<?=BASE_URL?>trainings/pi-partner-program-training-work-shop',
					className: 'important'
				},
	...
	<body>
		...
		<div class="main-panel" id="page-events">
			...
			<div class="content-wrapper">
				<h3 style="text-align:center;margin-bottom:0;">Training Calendar</h3>  
				<div id='wrap'>
