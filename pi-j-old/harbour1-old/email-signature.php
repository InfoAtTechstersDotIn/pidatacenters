...
<html>
   <head>
      ...
      <style type="text/css"> body{font-family:'Century gothic',sans-serif}*,:focus{outline:0}*{padding:0;margin:0}span{display:block}.fstyle{font-family:'Century gothic',sans-serif}img{vertical-align:middle;display:inline-block}.container{margin:0 auto;position:relative}@media only screen and (max-width:992px){.container{padding:0 12px}}@media(min-width:992px){.container{width:970px}}
a>img {
       padding: 6px;
    background-color: #fff;
    border-radius: 6px;
}
@media only screen and (min-width:1200px){.container{width:1200px}}::-webkit-scrollbar{width:6px;height:6px;border-radius:20px}::-webkit-scrollbar-button{display:none}::-webkit-scrollbar-track{background-color:#ccc}::-webkit-scrollbar-track-piece{background-color:#ccc}::-webkit-scrollbar-thumb{background-color:#2f1dac}::-webkit-scrollbar-thumb:hover{background-color:#2f1dac}::-webkit-scrollbar-corner{display:none}::-webkit-resizer{display:none}.signaturePart{position:relative;font-size:0;margin:100px auto 0}.left-signature,.right-data{position:relative;display:inline-block;width:50%;vertical-align:middle;font-size:14px}.form-group input{width:60%;height:36px;line-height:36px;border:1px solid #ccc;padding:0 12px;color:#545454;font-family:'Century gothic',sans-serif}.form-group+.form-group{margin-top:16px}.form-group label{margin-bottom:10px;font-weight:700;font-size:14px;display:block}input:active,input:focus,input:visited{border:2px solid #6a6adc}.ConformDiv{position:fixed;left:0;right:0;margin:-150px auto;top:50%;transform:scale(0);opacity:0;transition:.5s;z-index:999999;width:500px;height:300px;background-color:#2f1dac;border-radius:10px}.ConformDiv.open{opacity:1!important;transform:scale(1)!important}#overlay{position:absolute;top:0;bottom:0;background:#2f1daccc;width:100%;height:100%;opacity:.67;display:none;z-index:99;transition:all 1s ease}#overlay.active{display:block}.popD{text-align:center;position:absolute;left:0;right:0;margin:0 auto;vertical-align:middle;padding:36px;top:50%;transform:translateY(-50%);color:#fff}.popD h1{margin-bottom:12px}.closepop{margin:6px auto;display:block;margin-top:18px;border:none;font-size:14px;background-color:#fff;color:#2f1dac;padding:9px 24px;font-weight:700;cursor:pointer;border-radius:6px}#copytest{width:65%;height:36px;line-height:36px;color:#fff;background-color:#2f1dac;border:none;border-radius:6px;text-align:center;margin-top:24px}.form-group-label{margin:24px auto;}.form-group-label >label >input{vertical-align: middle;}.form-group-label >label > span{vertical-align: middle; padding-left: 8px; display: inline-block; font-weight: bold;}.none{display: none;}.mobile{display: none;}@media (max-width: 767px){.signaturePart{display: none;}.mobile{display: block; position: fixed; width: 100%; height: 100%; background-color: #6a6adc}.mobile h2{text-align: center; color: #fff; top: 50%; position: absolute; left: 0; right: 0; margin:-20px auto;}}</style>
   </head>
   <body>
      <div class="container">
         <div class="signaturePart">
            <div class="left-signature">
               <form method="post">
                  ...
                  <div class="form-group none"> <label>Linkedin</label> <input type="email" name="name" placeholder="https://www.linkedin.com/in/sivakrishna-maridu/" required="" autocomplete="off" class="smclinkedin"> </div>
                  <div class="form-group none"> <label>Twitter</label> <input type="text" name="twitter" placeholder="https://twitter.com/ddeyroy" required="" class="smctwitter" autocomplete="off"> </div>
               </form>
               ...
               <table cellpadding="0" cellspacing="0" >
                  <tr>
                     ...
                     <td>
                        <table>
                           <tr>
                              <td style="border-right:1px solid black"><a href='https://pidatacenters.com/' target="_blank" style="width:auto;height:auto"><img src="https://res.cloudinary.com/siva5456/image/upload/v1619594019/pi.png" width="80" style="" height="60" style="width: 60pt;display: inline-block; vertical-align: middle;"></a></td>
                              <td><a href="https://harbour1.in" style="display: inline-block;width:auto;height:auto"><img src="images/main-logo.png"  width="120" height="60" style="width:auto;display: inline-block;vertical-align: middle;"></a> </td>
                           </tr>
                        </table>
                     </td>
                  </tr>
                  ...
                  <tr >
                     <table>
                        <tr>
                           <td style="padding-top: 10pt"> <span><img src="https://harbour1.in/images/Signature.png" width="552px" style="display: block;"></span> </td>
                        </tr>
                     </table>
                  </tr>
                  <table cellpadding="0" cellspacing="0" style="padding-top: 8pt;" >
                     <tr style="background-color: #2f1dac;border-radius: 6pt;padding: 4px;">
                        <td style="font-family: 'Century gothic',sans-serif;color: #fff;font-size: 7.5pt;padding: 6px ">Vijayawada | Kochi | Hyderabad | Mumbai | Delhi | Bengaluru | Chennai </td>
