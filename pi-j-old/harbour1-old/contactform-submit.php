...
$con = mysqli_connect("localhost", "harbourdash", "Iaa4oubsCnitLVrH", "harbour1Forms");
...
//getting IP Address of the User
    ...
    VALUES ('$name', '$phone', '$company', '$bemail', '$subject', '$message', '$ip')";
        ...
        if (!$result_contactus) {
            ...
            // $mail->SetFrom('info@harbour1.in', 'Hosting Group Inc.'); //you need "send to" permission on that account, if dont use yourname@mail.org

            // //Set an alternative reply-to address
            // $mail->addReplyTo('srikanth.komakula@pidatacenters.com', 'First Last');

            // //Set who the message is to be sent to
            // $mail->addAddress('info@harbour1.in', 'SIMON MÜLLER');
            ...
            // $mail->Body = '<html><body>';
            // $mail->Body .= '<img src="https://pidatacenters.com/wp-content/uploads/2017/12/xPi-Logo-180x80.png,qv21.pagespeed.ic.jl8m2P42fh.webp" alt="Harbour1 Logo" />';
            ...
            // $mail->SMTPSecure = '';
            // $mail->SMTPAuth   = true;
            // $mail->Username = "info@harbour1.in";
            // $mail->Password = "Harbour1@pi123";
            // $mail->SetFrom('info@harbour1.in', 'Name');
            // $mail->addReplyTo('info@harbour1.in', 'Harobur1');
            // $mail->SMTPDebug  = 2;
            // $mail->IsHTML(true);
