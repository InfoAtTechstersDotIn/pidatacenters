...
class DashboardController extends Controller
{
    ...
    public function getDashboardData(Request $request) {
        ...
        $diffInMRC = $this->getFieldDiffForPeriod('mrc', $currPeriod, $prevPeriod) ;
        $dashboardData['mrc']['total'] = $this->getFieldTotalForPeriod('mrc', $currPeriod['startdate'], $currPeriod['enddate']);
        ...
        $diffInARC = $this->getFieldDiffForPeriod('arc', $currPeriod, $prevPeriod) ;
        $dashboardData['arc']['total'] = $this->getFieldTotalForPeriod('arc', $currPeriod['startdate'], $currPeriod['enddate']);
        ...
        $diffInOTC = $this->getFieldDiffForPeriod('otc', $currPeriod, $prevPeriod) ;
        $dashboardData['otc']['total'] = $this->getFieldTotalForPeriod('otc', $currPeriod['startdate'], $currPeriod['enddate']);
        ...
        $diffInACV = $this->getFieldDiffForPeriod('acv', $currPeriod, $prevPeriod) ;
        $dashboardData['acv']['total'] = $this->getFieldTotalForPeriod('acv', $currPeriod['startdate'], $currPeriod['enddate']);
        ...
        $diffInTCV = $this->getFieldDiffForPeriod('tcv', $currPeriod, $prevPeriod) ;
        $dashboardData['tcv']['total'] = $this->getFieldTotalForPeriod('tcv', $currPeriod['startdate'], $currPeriod['enddate']);
        ...
        $dashboardData['pipelinebystage'] = $this->getPipelinesByStage($currPeriod['startdate'], $currPeriod['enddate']);
        $dashboardData['pipelinebyrating'] = $this->getPipelinesByRating($currPeriod['startdate'], $currPeriod['enddate']);
        $dashboardData['pipelinebycust'] = $this->getPipelinesByCustType($currPeriod['startdate'], $currPeriod['enddate']);
        $dashboardData['pipelinebyindustry'] = $this->getPipelinesByIndustry($currPeriod['startdate'], $currPeriod['enddate']);
        $dashboardData['pipelinebysbu'] = $this->getPipelinesBySBU($currPeriod['startdate'], $currPeriod['enddate']);

        $dashboardData['revenueprojection'] = $this->getRevenueProjection();
...
*/
        ...
        $partner = Partner::where("business_email", '=', $userEmail)->first();

        $partnerId = 0;

        if ( $partner != null && $partner->user_type != Config::get('constants.user_types.PIADMIN')) {
    ...
    private function getFieldDiffForPeriod(string $field, array $currPeriod, array $prevPeriod) {

        $prevTotal = $this->getFieldTotalForPeriod($field, $prevPeriod['startdate'], $prevPeriod['enddate']);
        $curTotal = $this->getFieldTotalForPeriod($field, $currPeriod['startdate'], $currPeriod['enddate']);
    ...
    private function getPipelinesByStage(String $startDate, String $endDate) {
    ...
    private function getPipelinesByRating(string $startDate, string $endDate) {
        $data = [];
        $pipelines = DB::table('pipelines')
            ->where('status', '=', Config::get('constants.options.APPROVED'))
            ->whereDate('created_at', '>=', $startDate)
    ...
    private function getPipelinesByCustType(string $startDate, string $endDate) {
        $data = [];
        $pipelines = DB::table('pipelines')
            ->where('status', '=', Config::get('constants.options.APPROVED'))
            ->whereDate('created_at', '>=', $startDate)
    ...
    private function getPipelinesByIndustry(string $startDate, string $endDate) {
        $data = [];
        $pipelines = DB::table('pipelines')
            ->where('status', '=', Config::get('constants.options.APPROVED'))
            ->whereDate('created_at', '>=', $startDate)
    ...
    private function getPipelinesBySBU(string $startDate, string $endDate) {
        $data = [];
        $pipelines = DB::table('pipelines')
            ->where('status', '=', Config::get('constants.options.APPROVED'))
            ->whereDate('created_at', '>=', $startDate)
