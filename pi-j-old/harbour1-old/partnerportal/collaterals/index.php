                	...
                	<div class="content-wrapper">
						...
						<div class="col-md-4">
								<div class="" style="padding:10px 0px;" >
									<a href="<?=BASE_URL?>assets/images/collaterals/Partner-Brochure-FINAL.pdf" target="_blank"><img src="<?=BASE_URL?>assets/images/collaterals/thumb-new-part.jpeg" style="width:100%;"></a>
									<h5 style="padding:5px 0px">Partner Brochure</h5>
									...
									<button type="button" class="btn btn-primary"><a href="<?=BASE_URL?>assets/images/collaterals/Partner-Brochure-FINAL.pdf" target="_blank" style="color:white;text-decoration:none;">Read More</a></button>
								</div>
							</div>
						<div class="col-md-4">
								<div class="" style="padding:10px 0px;">
									<a href="<?=BASE_URL?>assets/images/collaterals/thumb-ten-com.jpeg" target="_blank"><img src="<?=BASE_URL?>assets/images/collaterals/thumb-ten-com.jpeg" style="width:100%;height:263px;"></a>
									<h5 style="padding:5px 0px">The 10 Commandments</h5>
									<!--<p style="text-align:justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever....</p>-->
									<button type="button" class="btn btn-primary"><a href="<?=BASE_URL?>assets/images/collaterals/commendments.png" target="_blank" style="color:white;text-decoration:none;">Read More</a></button>
								</div>
							</div>
							<div class="col-md-4">
								<div class="" style="padding:10px 0px;">
