              ...
              <table id="pending-pipelines" class="table table table-hover table-bordered" width="100%">
                <thead>
                  <tr class="table-row">
                    ...
                    <th class="th-sm">Service Business Unit (SBU)
                    </th>
        ...
        <div class="card-body">
          ...
          <!-- <form class="forms-sample"> -->
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <label for="exampleInputEmail3">RBP Sales Owner</label>
                <input type="text" class="form-control" id="salesowner" placeholder="RBP Sales Owner" disabled="">
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group col-md-12 col-sm-12">
                ...
                <textarea rows="5" class="form-control" id="oppor-details"  disabled=""></textarea>
              </div>
            </div>
        ...
        <div class="card-body">
          ...
          <form class="forms-sample" id="frm-pipeline-edit">
            ...
            <div class="row">   
              <div class="form-group col-md-4 col-sm-12">
                <label for="exampleInputEmail3">RBP Sales Owner</label>
                <input type="text" class="form-control" id="salesowner" name="salesowner" placeholder="RBP Sales Owner" required>
              </div>
	      <div class="form-group col-md-4 col-sm-12">
                <label for="exampleInputEmail3">Customer Name</label>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12 col-sm-12">
                  ...
                  <textarea name="oppor_details" class="form-control" id="oppo-details" required></textarea>
                </div>
            </div>
