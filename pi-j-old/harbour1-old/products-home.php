...
<div class="hb-bannerCont">
   <div class="hb-bannerImgCont">
      <div class="hb-bannerImg">
         <picture>
            <source media="(max-width: 767px)" srcset="images/banners/products_mbanner.png">
            <img  src="images/banners/products_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
         </picture>
      </div>
   </div>
</div>
...
<div id="banner-content" style="display: none;">
   <div class="container">
      <div class="hb-bannerInfo">
         <p class="text-center">Harbour1<sup>®</sup> offers a broad set of global cloud-based products including compute, storage, databases, analytics, networking, mobile, developer tools, management tools, IoT, security and enterprise applications. Harbour1<sup>®</sup> is trusted by the many enterprises, governments and startups to power a wide variety of workloads including: web and mobile applications, data processing and warehousing, storage, disaster recovery and many others.
         </p>
      </div>
      <ul class="hb-bannerList list-inline">
         ...
         <li>
            ...
            <p>Be prepared for the unexpected with Harbour1<sup>®</sup> enabling DR, secure remote work etc to ensure Enterprise business is up and running all time</p>
         </li>
         <li>
            <h3>Internet exchange @ Harbour1<sup>®</sup></h3>
   ...
   <div class="container">
      <div class="ex-deptCont">
         <div class="ex-dept-Left" >
            ...
            <p class="heading-para">Platform agnostic product stack on Harbour1 is designed and developed keeping in mind the business challenges faced by enterprises. Now businesses can pick suitable products to scale, grow and meet industry demands with ease, efficiency and optimised TCO.
</p>
         </div>
                  ...
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>Top Picks</h2>
                           <p>Most featured products and services on Harbour1<sup>®</sup></p>
                        </div>
                           ...
                           <li>
                                   <h3><a href="/compute">Virtual Machines</a></h3>
                                        <p>Develop, deploy & scale enterprise workloads on cloud</p>
                                              ...
                                              <li>
                                                <h3><a href="/network">HarbourFront<sup>TM</sup></a></h3>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>Compute</h2>
                           <p>Scale enterprise compute on demand, develop and manage enterprise containerized applications faster with integrated tools.. <a href="/compute">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                           <li>
                              <h3><a href="/compute">Virtual Machines</a></h3>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>Network </h2>
                           <p>Connect, scale and  secure  enterprise networks.. <a href="/network">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                           <li>
                           ...
                           <li>
                              ...
                              <p>Dedicated route from enterprise on -premises to Harbour1<sup>®</sup></p>
                           </li>
                           <li>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>Storage </h2>
                           <p>Get secure, massively scalable cloud storage for enterprise data, apps, and workloads.. <a href="/storage">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                           <li>
                  ...
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           ...
                           <p>Multiple layers of protection spread across the workloads, networks, programs, or data ..<a href="/security">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                           <li>
                           ...
                           <li>
                              <h3><a href="/security">Anti-virus</a></h3>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>SAP on Cloud </h2>
                           <p>Connect cloud and on-premises infrastructure and services to provide enterprise customers and users the best possible experience.. <a href="/sap">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                          <li>
                                             ...
                                             <li>
                                              ...
                                              <li>
                                                ...
                                                <p>Explore other SAP solutions on Harbour1<sup>®</sup> to transform enterprise business</p>
                                             </li>
                        </ul>
                     </div>
                  </div>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>Business Continuity</h2>
                           <p>Ensure enterprise workloads are safe from various cyber and physical threats and are up and running all the time..<a href="/business-continuity">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                           <li>
                              <h3><a href="/business-continuity">Disaster Recovery</a></h3>
               ...
               <li class="dept-list-group eg-heiAuto">
                  <div class="dept-list">
                     ...
                     <div class="full-cont hwi">
                        <div class="dep-moreInfp">
                           <h2>End user computing</h2>
                           <p>Virtual desktop infrastructure & application streaming through secured access ..<a href="/endusercomputing">Learn More ></a></p>
                        </div>
                        <ul class="list-inline child_deptCont">
                           <li>
