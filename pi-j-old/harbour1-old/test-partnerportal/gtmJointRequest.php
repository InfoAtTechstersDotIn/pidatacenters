...
<!--    **************************  -->  
      ...
      <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-fund-req" id="JointEventReq">
                     <div class="row">
                      <div class="form-group col-md-4 col-sm-12">
                        <label for="Event Name">Event Name </label>
                        <input type="email" class="form-control" id="jeEventName">
                      </div>
                      <div class="form-group col-md-4 col-sm-12">
                        <label for="RBP Region">Select Product / Service</label>
                        <select class="form-control " id="jeundproduct">
                        ...
                        <input type="number" class="form-control" id="jeeventcost">
                      </div>
                     ...
                     <div class="row">
                       <div class="form-group col-md-4 col-sm-12">
                        ...
                        <textarea class="form-control" id="jeObjective"></textarea>
                      </div>
                        <div class="form-group col-md-4 col-sm-12">
                        <label for="Audience">Target Audience</label>
                        <textarea class="form-control" id="jetargetAud"></textarea>
                      </div>
                       <div class="form-group col-md-4 col-sm-12">
                        <label for="Audience sponsers">Additional Sponsors(if any)</label>
                        <textarea class="form-control" id="jeaddSpo"></textarea>
                      </div>
                     </div>
                    <div class="row">
                       <div class="form-group col-md-4 col-sm-12">
                        <label for="Objective">Deliverables For Partner</label>
                        <textarea class="form-control" id="jeDeliverablesPart"></textarea>
                      </div>
                        <div class="form-group col-md-4 col-sm-12">
                        <label for="Audience">Deliverables For Pi</label>
                        <textarea class="form-control" id="jeDeliverablespi"></textarea>
                      </div>
                       <div class="form-group col-md-4 col-sm-12">
                        <label for="Audience sponsers">Additional Comments</label>
                        <textarea class="form-control" id="jeDeliverablesComments"></textarea>
                      </div>
                     </div>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        ...
                        <input type="text" class="form-control calVal" id="jeName">
                      </div>
                      <div class="form-group col-md-3 col-sm-12">
                        <label for="Eamil Id">Email ID</label>
                        <input type="email" class="form-control calVal" id="jeEmail" >
                      </div>
                        <div class="form-group col-md-3 col-sm-12">
                        <label for="Mobile Number">Mobile Number</label>
                        <input type="number" class="form-control calVal" id="jeMn" >
                      </div>
                      <div class="form-group col-md-3 col-sm-12">
                        <label for="Designation">Designation</label>
                        <input type="text" class="form-control calVal" id="jeuDe" >
                      </div>
                     </div>
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="form-group col-md-4 col-sm-12">
                        <label for="name">Name</label>
                        <input type="text" class="form-control calVal" id="jemName">
                      </div>
                      <div class="form-group col-md-4 col-sm-12">
                        <label for="Eamil Id">Email ID</label>
                        <input type="email" class="form-control calVal" id="jeEmail" >
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                        <label for="Mobile Number">Mobile Number</label>
                        <input type="number" class="form-control calVal" id="jemMn" >
                      </div>
                     ...
                     <div  >
                         <div class="row">
                          ...
                          <textarea class="form-control" id="jeparam"></textarea>
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                          <label for="Mobile Number">Enter Metric</label>
                         <textarea class="form-control" id="jemetric"></textarea>
                        </div>
                     ...
                     <div  >
                         <div class="row">
                          ...
                          <textarea class="form-control" id="jelocCover"></textarea>
                        </div>
                        <div class="form-group col-md-3 col-sm-12">
                          <label for="Mobile Number">Enter Social Media </label>
                         <textarea class="form-control" id="jeSocilaMedi"></textarea>
                        </div>
                          <div class="form-group col-md-3 col-sm-12">
                          <label for="EPrint Media  d">Enter Print Media   </label>
                          <textarea class="form-control" id="jePrntMe"></textarea>
                        </div>
                        <div class="form-group col-md-3 col-sm-12">
                          <label for="Mobile Number">Enter Institutional Branding </label>
                         <textarea class="form-control" id="jeInstuBrand"></textarea>
                        </div>
