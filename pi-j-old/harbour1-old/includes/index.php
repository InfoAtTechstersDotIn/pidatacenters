				...
				<div class="hb-bannerImg slider1">
					<picture>
			        	 <source media="(max-width: 767px)" srcset="images/banners/index_mbanner.png">
			      	   	<img  src="images/banners/index_banner.png" alt="Harbour1 Cloud Backup as a Service Banner" style="width:100%">
      				</picture>
				</div>
     	...
     	<div class="hb-cloudPlatform">
     		<div class="container">
     			<div class="hb-cloudCont text-center">
     				...
     				<p>As, India’s first enterprise cloud, Harbour1<sup>®</sup> mirrors, innovation, and thought re-engineering, backed by relentless industry research and technology assimilations. Being platform-agnostic, Harbour1<sup>®</sup> incubates scalability, high redundancy without compromising on critical security and regulatory compliance. A one stop shop with an array of products and services to meet enterprise business needs, delivering higher efficiency and optimised TCO. </p>
     			</div>
            ...
            <li>
             ...
             <li>
              <div class="hb-statCont  cc-color-4">
                  <h3><span class="Count">4</span></h3>
                  <h4 >Smart Cities</h4>
                  <p>With integrated IT, IoT and data on Harbour1<sup>®</sup>, delivering operational and service efficiency to citizens</p>
              </div>
            </li>
            <li>
               <div class="hb-statCont  cc-color-1">
           ...
           <ul class="list-inline hb-footerList">
             <li>
               <div class="hb-footerImgSec">
                    <a href="/"><img src="images/harbour_white.png" alt="harbour1"></a>
                    <p>Harbour1® mirrors, innovation, thought re-engineering, backed by relentless industry research and technology assimilations. It incubates, flexibility, scalability, high redundancy and being platform agnostic, into all our products and services</p>
                    <div class="hb-socialLinks hb-footerSlinks" style="margin:26px 0; text-align: left;">
                        <ul class="list-inline ">
                           <li style="padding-left:0px;"><a href="https://www.linkedin.com/company/harbour1%C2%AE/" target="_blank" rel="noreferrer"> <img src="images/menu-icons/linkedin_ico.svg" alt='linkedin'></a></li>
                           <li><a href="https://twitter.com/Harbour1Cloud" target="_blank" rel="noreferrer"> <img src="images/menu-icons/twitter_ico.svg" alt='twitter'></a></li>
                           ...
                           <li><a href="https://www.instagram.com/harbour1.in/"> <img src="images/menu-icons/Instagram_ico.svg" alt='insta'></a></li>
                           <li><a href="https://www.facebook.com/Harbour1-100292348760092/" target="_blank" rel="noreferrer"> <img src="images/menu-icons/facebook_ico.svg" alt='facebook'></a></li>
                        </ul>
                     </div>
