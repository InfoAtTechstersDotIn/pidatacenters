    ...
    <div class="container">
        <div class="article-blk-main added-tags">
            <div class="press-releases-popup row">
                ...
                <div class="col-lg-6">
                    <h1>What Are the Different Types of Data Centers in Cloud Computing?
                    </h1>
                    ...
                    <h2>Public cloud data centers </h2>
                    ...
                    <h2>Private cloud data centers </h2>
                    ...
                    <h2>Hybrid cloud data centers </h2>
