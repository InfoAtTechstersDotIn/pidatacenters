<?php
$seo_title = "Pi - Data Center Infrastructure Services (DCIM) in India";
$seo_description = "Comprehensive data center infrastructure services providing secure, scalable, and efficient solutions for businesses.";
$seo_keywords = "data center, infrastructure services, data center solutions, secure data storage, scalable infrastructure";
?>
        ...
        <div class="testimonial-block-main">
            <div class="tabBlock">
                ...
                <div class="tabBlock-pane">
                    <div class="dc-advisory-block row">
                        <div class="dc-advisory-block-lt col-md-6">
                            <img src="images/pmc-dc.png" alt="pmc-img" width="829" height="666">
                        </div>
                        <div class="dc-advisory-block-rt  col-md-6">
...
<div class="about-data-center-infrastructure-blk dc">
    <div class="container">
        <div class="about-data-center-infrastructure-main">
            <h2> Data Center <span style="color: #7BBC42;">Infrastructure </span></h2>
