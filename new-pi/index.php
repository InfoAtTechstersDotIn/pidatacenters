...
})(window,document,'script','dataLayer','GTM-T3L588D');</script>
...
">
      ...
      <![endif]-->
       <style>
	  nav > ul > li, nav>ul>li > ul.sub-menu {
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T3L588D"
                    ...
                    <div class="header-rt">
                      ...
                      <ul class="clear">
                         ...
                         <!--<li><a href="https://harbour1.in/" target="_blank">CLOUD</a></li>-->
                          ...
                          <li class=""><a href="./harbour1/" class=" drop-arrow">CLOUD</a>
                            <div class="drop-down">
                                <ul>
                                    <li>
                                        <a href="./harbour1/multi-cloud">Public Cloud</a>
                                    </li>
                                    <li>
                                        <a href="./harbour1/compute">Private Cloud</a>
                                    </li>
                                    <li><a href="./harbour1/sap">SAP on Cloud</a></li>
                                      <li><a href="./harbour1/products-home">Other Could Services</a></li>
                                       <li>
                                        <a href="certifications.php"> Cloud Certifications</a>
                                    </li>
                                       <li>
                                        <a href="./harbour1/industry-solutions">Industry Solutions</a>
                                    </li>
                                     
                                     <li>
                                        <a href="./harbour1/managed-services">Cloud Enablement</a>
                                    </li>
                         ...
                         <div class="drop-down">
                          <ul>
 <li>
                                        <a href="./harbour1/multi-cloud#servicemodel">Public Cloud
Managed
...
-->
                           ...
                           <li >
                             ...
                             <a href="JavaScript:void(0);" class=" drop-arrow">PRODUCTS</a>
                                        <div class="drop-down">
                                        <ul>
                                             <li ><a href="./harbour1/security"  target="_blank">Cyber Security</a></li>
                                             <li ><a href="./harbour1/ip-exchange" target="_blank">Internet Exchange (IPX)</a></li>
                                   <li>
                        ...
                        <li><a href="JavaScript:void(0);" class=" drop-arrow">PRICING</a>
                           <div class="drop-down">
                                <ul>
                                    <li>
                                        <a href="./harbour1/pricing/#/cloudServers">Cloud servers</a>
                                    </li>
                                    <li>
                                        <a href="./harbour1/pricing/#/cloudStorage">Cloud Storage</a>
                                    </li>
                                    <li>
  ...
  <li>
                                    ...
                                    <li>
                                        <a href="./harbour1/partners">Partner Portal</a>
                                    </li>
...
<ul class="sub-menu menu-odd  menu-depth-1">
    <li id="nav-menu-item-3444" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="data-center-infrastructure-services.php" class="menu-link sub-menu-link">Data Center Infrastructure and Services</a></li>
	...
	<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="dc-build.php" class="menu-link sub-menu-link">Data Center Build & Operate</a></li>
		...
		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="pi-work-spaces.php" class="menu-link sub-menu-link">Pi Workspaces</a></li>-->
                                 ...
                                 <li id="nav-menu-item-14" class="main-menu-item  menu-item-even menu-item-depth-0 single-menu menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a title="ABOUT US" href="JavaScript:void(0);" class="menu-link main-menu-link">CLOUD</a><span class="sub-menu-icon"></span>
<ul class="sub-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-172" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Leadership" href="about.php" class="menu-link sub-menu-link">Multi-Cloud</a></li>
	<li id="nav-menu-item-843" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="News" href="leadership.php" class="menu-link sub-menu-link">Private Cloud</a></li>
	<li id="nav-menu-item-2899" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Awards and Recognition" href="awards-recognition.php" class="menu-link sub-menu-link">Industry Solutions</a></li>
	<li id="nav-menu-item-3416" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="Careers" href="testimonial.php" class="menu-link sub-menu-link">Cloud Enablement</a></li>
...
<!--<li id="nav-menu-item-3868" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://harbour1.in/" class="menu-link main-menu-link">CLOUD</a></li>-->
  ...
  <li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="JavaScript:void(0);" class="menu-link sub-menu-link">MANAGED SERVICES</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
	    		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Public Cloud
Managed
...
<!--		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Public Cloud Support</a></li>-->
 ...
 <li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="JavaScript:void(0);" class="menu-link sub-menu-link">SERVICES</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
		<li id="nav-menu-item-3869" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://harbour1.in/security" class="menu-link sub-menu-link" >Cyber Security</a></li>
<!--		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Public Cloud Support</a></li>-->
		<li id="nav-menu-item-3871" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://harbour1.in/ip-exchange" class="menu-link sub-menu-link">Internet Exchange (IPX)</a></li>
...
<ul class="sub-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-172" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Leadership" href="life-at-pi.php" class="menu-link sub-menu-link">Cloud servers</a></li>
	<li id="nav-menu-item-843" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="News" href="work-with-us.php" class="menu-link sub-menu-link">Cloud Storage</a></li>
		<li id="nav-menu-item-843" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="News" href="work-with-us.php" class="menu-link sub-menu-link">Rent A Server</a></li>
			<li id="nav-menu-item-843" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="News" href="work-with-us.php" class="menu-link sub-menu-link">Rent GPU Servers</a></li>
...
<li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="JavaScript:void(0);" class="menu-link sub-menu-link">Career</a><span class="sub-menu-icon"></span>
	...
	<li id="nav-menu-item-3873" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="contact-us.php" class="menu-link sub-menu-link">Contact Us</a></li>
          ...
          <!--<div class="phone-call">
            <ul>
                <li>
                    <a href="#" class="animated fadeInDown wow">
                    <img src="images/component.png" alt="img" width="79" height="38">
                    </a>
                </li> 
                <li>
                    <a href="#" class="animated fadeInDown wow">
                    <img src="images/component-2.png" alt="img" width="79" height="38">
                    </a>
                </li> 
            </ul>
          </div> -->
         ...
         <div class="banner-blk desk">
                   ...
                   <div class="block-1">
                         ...
                         <div class="great-blk d-flex flex-wrap flex-row-reverse">
                             <div class="mobile-headings">
                                  ...
                                  <h2>We Believe in Empowering Businesses</h2>
                                     </div>
                             <div class="great-rt col-lg-6">
                             <div class="great-rt-in dc">
                             ...
                             <div class="great-lt col-lg-6 ">
                                 <div class="desktop-headings">
                                  <span class="dc">Your Trusted Data Center Partner</span>
                                  <h2>We Believe in Empowering Businesses</h2>
                                     </div>
                                <p>Leading enterprises and businesses harness our trusted state-of-the-art infrastructure to bring together and interconnect the goals & objectives that fuel their conquest. <small>Pi gives you the leverage to ascend with agility and speed through the most high-performing, secured, dependable, and efficient data center in the world. We ensure your seamless connection to customers and partners, and furnish world-class experiences.</small></p>
                                 <div class="certi">
                         ...
                         <div class="great-blk d-flex flex-wrap flex-row-reverse">
                             <div class="mobile-headings">
                                <span class="dc">Transforming Infrastructure Experience</span>
                                  <h2>Creating an Exceptional Digital Transformation Journey</h2>
                                 </div>
                             <div class="great-rt col-lg-6">
                             <div class="great-rt-in">
                             ...
                             <div class="great-lt col-lg-6 ">
                                ...
                                <p>At Pi, we innovate to protect, foster and influence the sustainable business world. 
                                 Our cutting-edge IT Infrastructure is serving businesses in empowering their holistic Go-to-Market mission.
                                </p>
                                 <div class="btn-blk">
                                     <ul class="row">
                                        <li><a href="live-latency/">Live Latency</a></li>
                                        <li><a href="meity.php">MeitY</a></li>
                                     </ul>
                                 </div>
                             </div>
                ...
                <ul class="row">
                    <li>
                     ...
                     <li>
                        <a href="#">
                         <img src="images/client-6.png" alt="img">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                         <img src="images/client-7.png" alt="img">
                        </a>
                    </li>
             </ul>
             </div>-->
                         ...
                         <div class="great-blk d-flex flex-wrap">
                             ...
                             <div class="great-rtt col-lg-8 " id="slider2">
                                <ul class="slider2">
                                    ...
                                    <li class="col-md-6">
                                    <a href="./harbour1/security" target="_blank">
                                        <figure>
...
<h3>Cyber Security</h3>
                                    ...
                                    <li class="col-md-6">
                                         <a href="./harbour1/ip-exchange" target="_blank">
                                        <figure>
                   ...
                   <div>
                        ...
                        <div class="datacenter-blk">
                        <div class="container">
                            <div class="datacenter-main hurbour1">
                                <div class="hurbour1-pi">
                       ...
                       <li class="col-md-4">
                           ...
                           <h3>Backup as a Service</h3>
                            <div class="know-more">
                             <a href="./harbour1/business-continuity" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                           <li class="col-md-4">
                         ...
                         <div class="know-more">
                             <a href="./harbour1/compute" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                        <li class="col-md-4">
                           ...
                           <h3>Managed Multi-cloud</h3>
                            <div class="know-more">
                             <a href="./harbour1/" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                                   <li class="col-md-4">
                        ...
                        <li class="col-md-4">
                           ...
                           <h3>Network as a Service</h3>
                             <div class="know-more">
                             <a href="./harbour1/network" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                                   <li class="col-md-4">
                           ...
                           <h3>Security as a Service </h3>
                             <div class="know-more">
                             <a href="./harbour1/security" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                       <li class="col-md-4">
                           ...
                           <h3>Storage as a Service </h3>
                                     <div class="know-more">
                             <a href="./harbour1/storage" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                      </ul>
                                <!--<div class="know-more">
                                    <a href="https://harbour1.in/" class="dc" target="_blank">Know More</a>
                                </div>-->
                            </div>
...
Institute Certified TIER IV Data Center, and Harbour1® - India’s first Enterprise
...
disruption. Kalyan is a man on a mission. 
</p> 
                                    
                                
                                   <div class="know-more">
                                    <a href="ceo-corner.php">Know More</a>
                                </div>
                             </div>
                         </div>
                     </div>
                     ...
                     <!--<div class="block-1 block-2">
                         ...
                         <div class="contact-blk d-flex flex-wrap">
                             <div class="contact-blk-lt col-lg-6">
                                <h3 class="story">CONTACT INFORMATION</h3>
                                 <p><i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:sales@pidatacenters.com">sales@pidatacenters.com </a><a href="mailto:marcom@pidatacenters.com" class="second"> marcom@pidatacenters.com</a></p>
                                 
                                     <p><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+918978517793" class="second">+91 89785 17793</a></p>
                                 <div class="address-map row">
                                     <div class="address-map-lt col-1">
                                         <i class="fa fa-map-marker" aria-hidden="true"></i>
                                    </div>
                                     <div class="address-map-center col-6">
                                        <p><b>Headquarters</b> <br> Pi DataCenters Pvt. Ltd. Survey # 49/P, Plot no -12 IT Park, Mangalagiri,  Amaravati,<br> Andhra Pradesh<br> Pin: 522503</p> 
                                    </div>
                                     <div class="address-map-rt col-5">
                                         <p><b>Marketing Office</b> <br> Pi DataCenters Pvt. Ltd. B904 & 905 The Platina, Gachibowli, Hyderabad, Telangana <br> Pin: 500032</p>
                                    </div>
                                 </div>
                                 
                                
                             </div>
                             <div class="contact-blk-rt col-lg-6">
                               <h3>Reach Us</h3>
                                 <ul class="row">
                                    <li class="col-6">
                              ...
                              <div class="contact-blk-btm"> <p><i><b>Other Regional Offices: Mumbai | Bengaluru | Chennai | Delhi | Kochi</b></i></p></div> 
...
<li><a href="https://api.whatsapp.com/send?phone=+918978517793&amp;text=Hi, I need more information on Pidatacenters" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true" style="background:#00a82d;color:white"></i></a></li>
                   ...
                   <div class="col-md-5 top-foot">
                    ...
                    <li>
                      <a href="https://harbour1.in/partners" >Partners</a>
                    </li>
                      <li>
...
//  infinite: true,
  ...
  responsive: [
    ...
    },
    {
	  ...
	  <script>
	   $(".services-footer-menu").click(function(){
     var dw = $(window).width();
     $content = $(".mobile-footer-sublist");
     if(dw < 1025 ){
...
s1.async=true;
s1.src='https://embed.tawk.to/64be59aacc26a871b02adbfa/1h63oshk2';
s1.charset='UTF-8';
