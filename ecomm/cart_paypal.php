                ...
                <div class="col-md-4 col-xs-12">
                    <div class="subtotal-content">
                        ...
                        <div class="row order-total cta">
                            <a href="#" onclick="initializePaypal()" class="btn btn-border btn-blue btn-dark">Proceed to Checkout</a>
                        </div>
            ...
            function initializePaypal() {
                paypal.Buttons({
                    createOrder() {
                        ...
                        formdata.append("total", '<?php echo $cart_total ?>');
                        formdata.append("currency", "USD");
                        formdata.append("paypal_create_order", "1");
                        ...
                        return fetch("controller.php", requestOptions)
                    ...
                    onApprove(data) {
                        ...
                        formdata.append("paypal_capture_payment", "1");
