        ...
        <div class="login-box">
            ...
            <form action="controller.php" method="POST" id="login-form">
                ...
                <div class="mt15 text-center">
                    <input type="submit" name="login_user" class="btn btn-border btn-blue btn-dark nomargin" value="Login" />
                </div>

                <div class="mt10 text-center">
                    <a href="forgot-password.php" id="forgot">Forgot your Password?</a>
                </div>
            </form>
            <!-- End of Login Form -->
