        ...
        <div class="login-box">
            ...
            <form action="controller.php" method="POST" id="login-form">
                <div class="text-center">
                    <h3 class="uppercase">Reset Password</h3>
                </div>

                <input type="hidden" name="email" value="<?php echo $_GET['email'] ?>" />
                <input type="text" name="otp" class="form-control mt15" placeholder="OTP" required>
                <input type="password" name="password" class="form-control mt15" placeholder="Password" required>

                <div class="mt15 text-center">
                    <input type="submit" name="verify_change_password_otp" class="btn btn-border btn-blue btn-dark nomargin" value="Validate" />
                </div>
            </form>
            <!-- End of Login Form -->
