               ...
               <div class="header-block">
                 ...
                 <div class="header-dtls">
                    ...
                    <div class="header-rt">
                       <nav>
                      <ul class="clear">
                         <li class=""><a href="https://pidatacenters.com/" >HOME</a></li>
                         <li class=""><a href="JavaScript:void(0);" class=" drop-arrow">ABOUT</a>
                            <div class="drop-down">
                                <ul>
                                    <li>
                         ...
                         <li ><a href="JavaScript:void(0);" class=" drop-arrow">DATA CENTER</a>
                          ...
                          <ul>
                                    <li>
                                        <a href="data-center-infrastructure-services.php">Data Center Infrastructure and Services</a>
                                    </li>
...
-->
                           ...
                           <li >
                             ...
                             <a href="JavaScript:void(0);" class=" drop-arrow">SERVICES</a>
                                        <div class="drop-down">
                                        <ul>
                                             <li ><a href="https://harbour1.in/security"  target="_blank">Cyber Security</a></li>
                                             <li ><a href="https://harbour1.in/ip-exchange" target="_blank">Internet Exchange (IPX)</a></li>
                                   <li>
                        ...
                        <li><a href="JavaScript:void(0);" class=" drop-arrow">CAREER</a>
                           <div class="drop-down">
                                <ul>
                                    <li>
  ...
  <li>
              ...
              <nav style="display:flex;" class="mobile-nav"> 
                                 ...
                                 <li id="nav-menu-item-14" class="main-menu-item  menu-item-even menu-item-depth-0 single-menu menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a title="ABOUT US" href="JavaScript:void(0);" class="menu-link main-menu-link">ABOUT</a><span class="sub-menu-icon"></span>
<ul class="sub-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-172" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Leadership" href="about.php" class="menu-link sub-menu-link">About Us</a></li>
	<li id="nav-menu-item-843" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="News" href="leadership.php" class="menu-link sub-menu-link">Leadership</a></li>
	<li id="nav-menu-item-2899" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Awards and Recognition" href="awards-recognition.php" class="menu-link sub-menu-link">Awards and Recognition</a></li>
	<li id="nav-menu-item-3416" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="Careers" href="testimonial.php" class="menu-link sub-menu-link">Testimonials</a></li>
	<li id="nav-menu-item-2853" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Certifications" href="certifications.php" class="menu-link sub-menu-link">Certifications</a></li>
...
<li id="nav-menu-item-14" class="main-menu-item  menu-item-even menu-item-depth-0 single-menu menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a title="ABOUT US" href="JavaScript:void(0);" class="menu-link main-menu-link">CAREERS</a><span class="sub-menu-icon"></span>
<ul class="sub-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-172" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a title="Leadership" href="life-at-pi.php" class="menu-link sub-menu-link">Life at Pi</a></li>
	<li id="nav-menu-item-843" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a title="News" href="work-with-us.php" class="menu-link sub-menu-link">Openings</a></li>
                         ...
                         <div class="great-blk d-flex flex-wrap">
                             ...
                             <div class="great-rtt col-lg-8 " id="slider2">
                                <ul class="slider2">
                                    ...
                                    <li class="col-md-6">
                                    <a href="https://harbour1.in/security" target="_blank">
                                        <figure>
...
<h3>Cyber Security</h3>
                                    ...
                                    <li class="col-md-6">
                                         <a href="https://harbour1.in/ip-exchange" target="_blank">
                                        <figure>
                   ...
                   <div>
                       ...
                       <li class="col-md-4">
                           ...
                           <h3>Backup as a Service</h3>
                            <div class="know-more">
                             <a href="https://harbour1.in/business-continuity" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                           <li class="col-md-4">
                         ...
                         <div class="know-more">
                             <a href="https://harbour1.in/compute" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                        <li class="col-md-4">
                        ...
                        <li class="col-md-4">
                           ...
                           <h3>Network as a Service</h3>
                             <div class="know-more">
                             <a href="https://harbour1.in/network" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                                   <li class="col-md-4">
                           ...
                           <h3>Security as a Service </h3>
                             <div class="know-more">
                             <a href="https://harbour1.in/security" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                       <li class="col-md-4">
                           ...
                           <h3>Storage as a Service </h3>
                                     <div class="know-more">
                             <a href="https://harbour1.in/storage" class="dc" target="_blank">Know More</a>
                                          </div>
                           </div>
                        </li>
                      </ul>
