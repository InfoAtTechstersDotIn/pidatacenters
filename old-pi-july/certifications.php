...
<?php include('php/inner-header.php');?>
         <!-- main starts here -->
          ...
          <div class="certifications-block">
              <div class="container">
                  <div class="certifications-block-main">
                         <!--<h3>Certifications</h3>
                         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam dui mauris, vehicula vel commodo at, sollicitudin <br> sed magna. Quisque nec ligula ligula. Ut tincidunt molestie auctor. Morbi in lacus sit amet odio ornare tincidunt ut <br> vitae nunc. Praesent iaculis luctus nisl, quis</p>-->
                             ...
                             <li class="col-md-3">
                                            <figure>
                                             <img src="images/certification-7.jpg" alt="certification-1" width="543" height="664">
                                            </figure> 
                             </li>
                             <li class="col-md-3">
                                            <figure>
