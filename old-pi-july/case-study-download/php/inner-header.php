             ...
             <div class="header-block">
                 ...
                 <div class="header-dtls">
                    ...
                    <div class="header-rt">
                       <nav>
                      <ul class="clear">
                         <li ><a href="https://pidatacenters.com/" class="">HOME</a></li>
                         <li><a href="#" class=" drop-arrow">ABOUT</a>
                            <div class="drop-down">
                                <ul>
                                    <li>
                         ...
                         <li ><a href="#" class=" drop-arrow">DATA CENTER</a>
                              <div class="drop-down">
                          <ul>
                                    <li>
                                      ...
                                      <li class="down-ar">
                                        <a href="#">Consulting & Data Center Build
                         ...
                         <li ><a href="https://harbour1.in/" target="_blank">CLOUD</a></li>
                          <li><a href="#" class=" drop-arrow">MANAGED SERVICES</a>
                         <div class="drop-down">
                          <ul>
                              <li>
...
-->
                        ...
                        <li><a href="#" class=" drop-arrow">CAREER</a>
                           <div class="drop-down">
                                <ul>
                                    <li>
...
-->
                                                    <li>
                                                        <a href="brochure#tab1?title='Product-Portfolio'">Brochure</a>
                                                    </li>
              ...
              <!--<div class="menu">
                 <div id="nav-icon">
                    ...
                    <span></span>
                                 ...
                                 <li id="nav-menu-item-14" class="main-menu-item  menu-item-even menu-item-depth-0 single-menu menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a title="ABOUT US" href="#" class="menu-link main-menu-link">ABOUT</a><span class="sub-menu-icon"></span>
...
<li id="nav-menu-item-3432" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a href="#" class="menu-link main-menu-link">DATA CENTER</a><span class="sub-menu-icon"></span>
<ul class="sub-menu menu-odd  menu-depth-1">
	...
	<li id="nav-menu-item-3444" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Consulting & Data Center Build</a>
...
<li id="nav-menu-item-3868" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://harbour1.in/" class="menu-link main-menu-link">CLOUD</a></li>
  ...
  <li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="#" class="menu-link sub-menu-link">MANAGED SERVICES</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
...
<!--		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Public Cloud Support</a></li>-->
		...
		<li id="nav-menu-item-3872" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="dev-ops.php" class="menu-link sub-menu-link">DevOps</a></li>
		
	</ul>
</li>
                                                                
 <li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="#" class="menu-link sub-menu-link"> SERVICES</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
...
<li id="nav-menu-item-14" class="main-menu-item  menu-item-even menu-item-depth-0 single-menu menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a title="ABOUT US" href="#" class="menu-link main-menu-link">CAREERS</a><span class="sub-menu-icon"></span>
<ul class="sub-menu menu-odd  menu-depth-1">
...
<li id="nav-menu-item-3432" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a href="#" class="menu-link main-menu-link">MORE INFORMATION</a><span class="sub-menu-icon"></span>
<ul class="sub-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-3444" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="#" class="menu-link sub-menu-link">Knowledge Center</a>
	<span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
...
<!--		<li id="nav-menu-item-3870" class="sub-menu-item sub-sub-menu-item menu-item-even menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="knowledge-hub.php" class="menu-link sub-menu-link">Knowledge Hub</a></li>-->
	...
	<li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="#" class="menu-link sub-menu-link">Media</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
...
<li id="nav-menu-item-3445" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="#" class="menu-link sub-menu-link">Policies</a><span class="sub-menu-icon"></span>
	<ul class="sub-menu menu-even sub-sub-menu menu-depth-2">
	...
	<li id="nav-menu-item-3873" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="https://pidatacenters.com/contact-us.php" class="menu-link sub-menu-link">Contact Us</a></li>
