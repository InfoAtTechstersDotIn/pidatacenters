        ...
        <div class="article-blk-main added-tags">
            <div class="press-releases-popup row">
                <div class="col-md-12 show-img-mobile py-2">
                    <img src="images/multi-layer-cs.jpeg" alt="pr-image-2" width="1280" height="670">
                </div>
                <div class="col-lg-6">
                    <h1>Why Cybersecurity Is a Buzz Word Across Industries ?</h1>
                    ...
                    <p><b class="font-color">Challenge:</b> Financial institutions are prime targets for cyberattacks due to the vast amounts of sensitive financial data they handle. The constant evolution of cyber threats, such as phishing, ransomware, and DDoS attacks, keeps these organizations on their toes. </p>
                    <h2>Ransom DDoS attacks saw a year over year increase of 67% and a quarter over quarter increase of 24%, according to industry reports. </h2>
                    ...
                    <p><b class="font-color">Challenge: </b> The healthcare sector holds valuable patient records, clinical data from computerized provider order entry (CPOE), data from clinical support systems, machine-generated medical data, smartphone health apps, emergency care data, news, and medical journal articles, making it attractive to cybercriminals. The rise of telemedicine and interconnected medical devices also widens the attack surface. </p>


                    <h2> With an average data breach cost of $10.10 million in 2022, the healthcare sector has been the most expensive for breaches for 12 years running. </h2>
                    ...
                    <p><b class="font-color">Challenge:</b> Online retailers are susceptible to data breaches, impacting customer trust. Payment card information and personal details are valuable targets. </p>

                    <h2>In 2022, e-commerce companies lost $41 billion due to online payment fraud, according to industry reports. This number is anticipated to reach $48 billion by 2023's end. </h2>
                ...
                <div class="col-lg-6">
                    ...
                    <p><b class="font-color">Challenge:</b> As industrial processes become more automated and interconnected, the manufacturing industry faces increased exposure to cyber threats. Attacks on critical infrastructure can disrupt production and cause financial losses. </p>

                    <h2>There was a 43% increase in cryptojacking in 2022 and an astounding 87% increase in IoT malware. </h2>
                    ...
                    <p><b class="font-color">Challenge:</b> Educational institutions store vast amounts of student and staff data. The shift to online learning has further increased their vulnerability to cyberattacks. </p>

                    <h2>A study found that software vulnerabilities, phishing, and the use of Remote Desktop Protocol (RDP) were the main reasons for ransomware incidents. </h2>
                    ...
                    <h2>In 2022, $4.50 million was the average cost of breaches brought on by compromised or lost credentials. This figure represents a significant increase compared to previous years, highlighting the growing impact of credential-related breaches on organizations. </h2>
