...
<div class="hb-bannerCont">
	<div class="hb-bannerImgCont">
		<div class="hb-bannerImg">
			<!--<picture>
			     <source media="(max-width: 768px)" srcset="./pi-cloud/images/banners/network_mbanner.png">
			      <img  src="./pi-cloud/images/banners/network_banner.png" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
      		</picture>
      		<picture>-->
			<source media="(max-width: 768px)" srcset="./pi-cloud/images/banners/network-banner.jpg">
			<img src="./pi-cloud/images/banners/network-banner.jpg" alt="pi-cloud Cloud Backup as a Service Banner" style="width:100%">
			</picture>
			<h1>Network</h1>
		</div>
	</div>
		...
		<div class="hb-childProducts">
			...
			<div id="outer" class="skltbs-theme-light" data-skeletabs='{ "startIndex": 2 }'>
				<ul class="skltbs-tab-group list-inline text-center">
					<li class="skltbs-tab-item box-pad current">
						<button class="skltbs-tab tab-link" data-tab="tab-2">Scale</button>
					</li>
					<li class="skltbs-tab-item box-pad">
				...
				<div class="skltbs-panel-group">
					<div class="skltbs-panel " id="tab-1">
					...
					<div class="skltbs-panel current" id="tab-2">
						<ul class="hb-productSec list-inline">
							<li>
								<div class="hb-leftCont hb_ppCont">
									<span>
							...
							<li>
								<div class="hb-rightCont hb_ppCont">
									...
									<p class="para-color">Harbourfront<sup>TM</sup><a href="content-delivery-network-cdn.php">(CDN)</a>, India's first indigenous content service ensures high availability and performace. By geographically distributing a network of proxy servers and caching data spatially relative to end users, Harbourfront<sup>TM</sup>(CDN) ensures ensures high availability and performance. It can be used for content storage and delivery service for web acceleration, file download optimization, transcoding, video on demand and live streaming. <br> <a href="content-delivery-network-cdn.php" style="color: #fff;/* padding-left: 24px; */padding: 5px 10px;font-size: 14px;border-radius: 29px;background-color: #3d1b9b;">Learn More &gt;</a></p>
								</div>
							</li>
							<li>
								<div class="hb-leftCont hb_ppCont">
									...
									<p class="para-color">Enterprises can leverage Pi Cloud to distribute workloads and compute resources on hybrid and heterogeneous cloud environments. This service is adopted by enterprises to dynamically manage resource allocation and workload demands. Lower cost of ownership, ease of scale and manageability, are some of its key advantages over conventional on-premise load balancing . </p>
								</div>
							</li>
							<li>
								<div class="hb-rightCont hb_ppCont">
						...
						<ul class="hb-productSec list-inline">
							...
							<li>
								<div class="hb-rightCont hb_ppCont">
									...
									<p class="para-color">FWaaS on Pi Cloud is the first layer of defence for enterprise workloads and eliminates the need for appliance form factor. Our fwaas ensures perimter level security for enterprises at their hub offices,branch locations and end-points. All of these without the need to install additional hardware. </p>
