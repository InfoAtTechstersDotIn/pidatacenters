            ...
            <table cellpadding="0" cellspacing="0">
               ...
               <table cellpadding="0" cellspacing="0" style="padding-top: 8pt;">
                  <tr style="background-color: #2f1dac;border-radius: 6pt;padding: 4px;">
                     ...
                     <td style="padding-left: 6pt;padding-right: 6px;padding: 6px; background-color: #ccc;">
                        <table>
                           <h6 style="text-align: center; padding: 6px 0; color: #fff; font-size: 12px;">Follow Us On</h6>
                           <tr>
                              <td style="padding:0px 2pt"> <a href="https://www.linkedin.com/company/6437312/admin/" target="_blank" class="smc-link" style="display: inline-block;text-align: center; vertical-align: middle;"> <img src="images/ICONS/linkedin_ico.png" height="15" width="15"> </a> </td>

                              <td><a href="https://twitter.com/Pi_DATACENTERS" class="smctwi" target="_blank" style="display: inline-block;text-align: center; vertical-align: middle;"> <img src="images/ICONS/twitter_ico.png" height="15" width="15"> </a></td>

                              <td style="padding:0px 2pt"><a href="https://www.facebook.com/PiDATACENTERS/" class="smcfac" target="_blank" style="display: inline-block;text-align: center; vertical-align: middle;"> <img src="images/ICONS/facebook_ico.png" height="15" width="15"> </a> </td>

                              <td><a href="https://www.youtube.com/channel/UCcrUri8y8maUmz3P_9uCeJg" class="smcytube" target="_blank" style="display: inline-block;text-align: center; vertical-align: middle;"> <img src="images/ICONS/youtube_ico.png" height="15" width="15"> </a></td>


                              <td style="padding:0px 2pt"><a href="https://api.whatsapp.com/send?phone=+918712630334&text=Hi, I need more information on Pidatacenters" class="smcwtsapp" target="_blank" style="display: inline-block;text-align: center; vertical-align: middle;"> <img src="images/ICONS/Whatsapp_ico.png" height="15" width="15"> </a></td>
                           </tr>
                        </table>
                     </td>
                  </tr>
